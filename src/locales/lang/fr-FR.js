...
const locale = {
  ...
  "aiAssetAnalysis.copilot.openStrategyV2Ide": "Ouvrir l’éditeur de scripts de trading",
  "aiAssetAnalysis.copilot.scriptStrategyReady": "Le brouillon du script de trading est prêt. Continuez à l’affiner ici ou ouvrez l’éditeur pour le modifier, le tester et le publier.",
  ...
  "backtest-center.tradeColumns.balance": "Equity Left",
  ...
  "backtest-center.tradeColumns.quantity": "Quantit\u00e9",
  "backtest-center.tradeColumns.valueUsd": "Valeur (USD)",
  ...
  "executorStrategies.catalog.layered_martingale": "Five-layer basket martingale with three child orders per layer.",
  ...
  "trading-assistant.editor.aiHint": "Pick a template first, then adjust strategy parameters. Strategy source owns instrument, market type, frequency, direction, sizing and risk; the run panel owns capital, dates and permitted Crypto swap leverage.",
  ...
  "trading-assistant.editor.codeParamsDesc": "Detected from context.params(...) and # @strategy risk annotations in the current script. Adjust values here and apply them back to the code.",
  ...
  "trading-assistant.editor.templateIntroDesc": "Start from a blank script or a database script template. Symbol, spot/swap, direction, investment amount, and leverage are selected in the run panel.",
...
export default {
  ...
  "trading-assistant.editor.ctaBlankTemplateDesc": "Start from the CTA handle_data(ctx, bar) contract.",
  ...
  "universeLibrary.portfolioNotice": "Choose Use in strategy to persist the universe with this portfolio strategy. Backtest and deployment will reuse the same selection.",
  "universeLibrary.ctaNotice": "CTA currently trades one configured instrument. You can inspect and copy universe references here, but linking a universe is available for portfolio strategies.",
  "universeLibrary.currentSelection": "Current strategy universe",
  ...
  "universeLibrary.codeReferenceHint": "Copying this code does not change or link the current strategy.",
  "universeLibrary.noMembers": "No members are available for this universe.",
  "universeLibrary.selectHint": "Select a universe to inspect its members and reference.",
  "universeLibrary.copySuccess": "Universe reference copied.",
  ...components,
  ...locale,
