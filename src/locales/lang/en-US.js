...
const components = {
  ...
  "portfolioTemplate.momentum.description": "Ranks the point-in-time universe by trailing return and holds equal-weight leaders.",
  "portfolioTemplate.lowVolatility.name": "Low Volatility Top-N",
  "portfolioTemplate.lowVolatility.description": "Ranks by realized volatility and holds the lowest-risk names.",
  "portfolioTemplate.meanReversion.name": "Mean Reversion Top-N",
  "portfolioTemplate.meanReversion.description": "Ranks by negative trailing return and holds recent laggards.",
  "portfolioTemplate.smallCap.name": "Small Cap Top-N",
  "portfolioTemplate.smallCap.description": "Ranks by point-in-time market capitalization and holds the smallest eligible companies. Requires fundamental data.",
  "factor.market_cap.name": "Market Capitalization",
  "factor.market_cap.description": "Point-in-time total equity market value; lower values indicate smaller companies.",
  "factor.momentum.name": "Momentum",
  "factor.momentum.description": "Cumulative price return over the selected period, measuring trend continuation strength.",
  "factor.sma.name": "Simple Moving Average",
  "factor.sma.description": "Arithmetic mean of closing prices over a period, available to CTA strategies for price-versus-average rules.",
  "factor.ema.name": "Exponential Moving Average",
  "factor.ema.description": "Moving average weighted toward recent prices, using the system-wide SMA seed convention.",
  "factor.sma_distance.name": "Price Distance from SMA",
  "factor.sma_distance.description": "Percentage distance between the latest close and its simple moving average.",
  "factor.ema_distance.name": "Price Distance from EMA",
  "factor.ema_distance.description": "Percentage distance between the latest close and its exponential moving average.",
  "factor.roc.name": "Rate of Change",
  "factor.roc.description": "Rate of change from the price observed a selected number of periods ago.",
  "factor.rsi.name": "Relative Strength Index",
  "factor.rsi.description": "Wilder-smoothed relative strength oscillator used for momentum and overbought/oversold states.",
  "factor.macd.name": "MACD",
  "factor.macd.description": "Fast/slow EMA difference, signal line or histogram selected through the output parameter.",
  "factor.bollinger_bands.name": "Bollinger Bands",
  "factor.bollinger_bands.description": "Standard-deviation channel around a moving average, returning a band, bandwidth or price position.",
  "factor.stochastic.name": "Stochastic Oscillator",
  "factor.stochastic.description": "Closing-price position within the recent high-low range, returning smoothed K or D.",
  "factor.kdj.name": "KDJ",
  "factor.kdj.description": "Stochastic variant common in Chinese markets, seeded at 50 and returning K, D or J.",
  "factor.cci.name": "Commodity Channel Index",
  "factor.cci.description": "Standardized typical-price distance from its moving average and mean deviation.",
  "factor.williams_r.name": "Williams %R",
  "factor.williams_r.description": "Inverse percentage position of the close within the recent highest-high and lowest-low range.",
  "factor.mfi.name": "Money Flow Index",
  "factor.mfi.description": "Volume-weighted oscillator combining typical-price direction and money flow.",
  "factor.adx.name": "Average Directional Index",
  "factor.adx.description": "Wilder trend-strength indicator returning ADX, +DI or -DI.",
  "factor.aroon.name": "Aroon",
  "factor.aroon.description": "Measures trend timing from recent highs and lows, returning Up, Down or the oscillator.",
  "factor.trix.name": "TRIX",
  "factor.trix.description": "One-period rate of change of a triple EMA, filtering short-term noise from trend momentum.",
  "factor.supertrend.name": "SuperTrend",
  "factor.supertrend.description": "Wilder-ATR trend-following channel returning trend direction or the active line.",
  "factor.atr.name": "Average True Range",
  "factor.atr.description": "Wilder-smoothed average true range measuring absolute price volatility.",
  "factor.downside_volatility.name": "Downside Volatility",
  "factor.downside_volatility.description": "Annualized volatility calculated from negative returns only.",
  "factor.max_drawdown.name": "Rolling Maximum Drawdown",
  "factor.max_drawdown.description": "Largest peak-to-trough decline within the selected window.",
  "factor.donchian_channels.name": "Donchian Channels",
  "factor.donchian_channels.description": "Breakout channel formed by recent highs and lows, returning a band or price position.",
  "factor.keltner_channels.name": "Keltner Channels",
  "factor.keltner_channels.description": "Volatility channel formed by an EMA plus or minus an ATR multiple.",
  "factor.volume_ratio.name": "Volume Ratio",
  "factor.volume_ratio.description": "Latest volume divided by average volume over the selected window.",
  "factor.obv.name": "On-Balance Volume",
  "factor.obv.description": "Directionally accumulated volume, returning its level or normalized slope.",
  "factor.ad_line.name": "Accumulation/Distribution Line",
  "factor.ad_line.description": "Volume accumulated from the close location within each bar, returning its level or normalized slope.",
  "factor.chaikin_oscillator.name": "Chaikin Oscillator",
  "factor.chaikin_oscillator.description": "Fast-minus-slow EMA of the accumulation/distribution line, normalized by volume scale.",
  "factor.vwap.name": "Volume-Weighted Average Price",
  "factor.vwap.description": "Volume-weighted typical price over a window, returning VWAP or the latest price distance.",
  "factor.cmf.name": "Chaikin Money Flow",
  "factor.cmf.description": "Money-flow volume divided by total volume over a selected window.",
  "factor.realized_volatility.name": "Realized Volatility",
  "factor.realized_volatility.description": "Annualized historical volatility calculated from daily returns; lower values usually indicate lower risk.",
  "factor.ema_slope.name": "EMA Slope",
  "factor.ema_slope.description": "Relative change in an exponential moving average over a selected window, measuring trend direction and strength.",
  "factor.atr_pct.name": "ATR Percentage",
  "factor.atr_pct.description": "Average true range divided by the latest close, making volatility comparable across instruments.",
  "factor.volume_zscore.name": "Volume Z-Score",
  "factor.volume_zscore.description": "Standardized deviation of the latest volume from its rolling historical mean.",
  "factor.mean_reversion_zscore.name": "Mean Reversion Z-Score",
  "factor.mean_reversion_zscore.description": "Standardized price deviation from its rolling mean; lower values usually indicate relative oversold conditions.",
  "factor.turnover_proxy.name": "Turnover Proxy",
  "factor.turnover_proxy.description": "Rolling mean of price times volume, used as a liquidity and trading-activity proxy.",
  "factor.earnings_yield.name": "Earnings Yield",
  "factor.earnings_yield.description": "Net income divided by market capitalization; higher values usually indicate cheaper valuation.",
  "factor.book_to_price.name": "Book-to-Price",
  "factor.book_to_price.description": "Book value divided by market capitalization, measuring value exposure.",
  "factor.return_on_equity.name": "Return on Equity",
  "factor.return_on_equity.description": "Net income divided by shareholder equity, measuring profitability quality.",
  "factor.revenue_growth.name": "Revenue Growth",
  "factor.revenue_growth.description": "Growth in the latest reported revenue relative to the previous period.",
  "factor.debt_to_equity.name": "Debt to Equity",
  "factor.debt_to_equity.description": "Total debt divided by shareholder equity; lower values usually indicate lower financial leverage risk.",
  "factor.free_cash_flow_yield.name": "Free Cash Flow Yield",
  "factor.free_cash_flow_yield.description": "Free cash flow divided by market capitalization, measuring cash-flow valuation.",
  "factorLibrary.title": "Factor Library",
  "factorLibrary.subtitle": "Built-in factor registry",
  "factorLibrary.description": "Inspect definitions, data requirements and standard strategy usage. Newly registered backend factors appear automatically.",
  "factorLibrary.portfolioOnly": "Portfolio strategies",
  "factorLibrary.ctaNotice": "Technical factors are available in CTA through ctx.factor(\"factor_id\", ...). Fundamental factors are portfolio-only, and bars after the current candle are never included.",
  "factorLibrary.portfolioNotice": "Portfolio strategies call ctx.factor(\"factor_id\", panel, ...) across the point-in-time universe. Both technical and point-in-time fundamental factors are available.",
  "factorLibrary.availableCount": "{count} available for {scope}",
  "factorLibrary.scope.current": "Available here",
  "factorLibrary.scope.all": "All runtimes",
  "factorLibrary.scope.cta": "CTA strategy",
  "factorLibrary.scope.portfolio": "Portfolio / cross-sectional",
  "factorLibrary.notAvailableHere": "Unavailable here",
  "factorLibrary.unsupportedCurrent": "This factor cannot be called from the current strategy type. You can inspect it here and copy code after switching to a supported strategy type.",
  "factorLibrary.searchPlaceholder": "Search name, function, category or field",
  "factorLibrary.all": "All",
  "factorLibrary.technical": "Technical",
  "factorLibrary.fundamental": "Fundamental",
  "factorLibrary.refresh": "Refresh",
  "factorLibrary.empty": "No matching factors",
  "factorLibrary.selectHint": "Select a factor to inspect its details",
  "factorLibrary.copyCall": "Copy call",
  "factorLibrary.copyExample": "Copy full example",
  "factorLibrary.copySuccess": "Factor usage copied",
  "factorLibrary.copyFailed": "Copy failed. Select and copy the code manually.",
  "factorLibrary.loadFailed": "Failed to load factor library",
  "factorLibrary.type": "Type",
  "factorLibrary.category": "Category",
  "factorLibrary.direction": "Ranking direction",
  "factorLibrary.runtime": "Runtime",
  "factorLibrary.portfolioRuntime": "Portfolio / cross-sectional",
  "factorLibrary.runtimeBoth": "CTA + portfolio / cross-sectional",
  "factorLibrary.runtimeCta": "CTA strategy",
  "factorLibrary.runtimePortfolio": "Portfolio / cross-sectional",
  "factorLibrary.requiredFields": "Required data fields",
  "factorLibrary.defaultParams": "Default parameters",
  "factorLibrary.parameters": "Call parameters",
  "factorLibrary.resetParams": "Reset defaults",
  "factorLibrary.noParams": "No parameters",
  "factorLibrary.strategyUsage": "Standard strategy usage",
  "factorLibrary.pointInTimeWarning": "Fundamental fields must use point-in-time data available on that date. Do not backfill future filings into history.",
  "factorLibrary.neutralHint": "Neutral factors have no prescribed preference. Choose ascending, descending, or filter-only use according to the strategy hypothesis.",
  "factorLibrary.type.technical": "Technical",
  "factorLibrary.type.fundamental": "Fundamental",
  "factorLibrary.direction.higher_is_bullish": "Higher is preferred",
  "factorLibrary.direction.lower_is_bullish": "Lower is preferred",
  "factorLibrary.direction.neutral": "Strategy-defined",
  "factorLibrary.category.momentum": "Momentum",
  "factorLibrary.category.risk": "Risk",
  "factorLibrary.category.trend": "Trend",
  "factorLibrary.category.liquidity": "Liquidity",
  "factorLibrary.category.reversal": "Reversal",
  "factorLibrary.category.size": "Size",
  "factorLibrary.category.valuation": "Valuation",
  "factorLibrary.category.quality": "Quality",
  "factorLibrary.category.growth": "Growth",
  "factorLibrary.category.cashflow": "Cash flow",
  "factorLibrary.category.volatility": "Volatility",
  "factorLibrary.category.volume": "Price and volume",
  "universe.catalog.hkCore": "Hong Kong Core Stocks",
  "universe.catalog.hkEtf": "Hong Kong ETFs",
  ...
  "universe.catalog.hkHighDividend50": "Hang Seng High Dividend Yield 50",
  "universeManager.kicker": "Research universes",
  "universeManager.title": "Universes",
  "universeManager.subtitle": "Use maintained system universes, manage personal universes, and inspect every constituent.",
  "universeManager.reload": "Reload",
  "universeManager.create": "Create universe",
  "universeManager.edit": "Edit",
  "universeManager.name": "Name",
  "universeManager.market": "Market",
  "universeManager.members": "Constituents",
  "universeManager.memberHint": "One symbol per line. Mixed universes use Market:Symbol.",
  "universeManager.placeholder": "AAPL\nMSFT\nNVDA",
  "universeManager.mixedPlaceholder": "USStock:AAPL\nHKStock:00700",
  "universeManager.cancel": "Cancel",
  "universeManager.save": "Save",
  "universeManager.symbols": "symbols",
  "universeManager.search": "Search universes",
  "universeManager.searchMembers": "Search symbol or name",
  "universeManager.allMarkets": "All markets",
  "universeManager.empty": "No universes in this category",
  "universeManager.version": "Data date",
  "universeManager.viewMembers": "View constituents",
  "universeManager.copyToMine": "Copy to mine",
  "universeManager.copySuffix": "Copy",
  "universeManager.copied": "System universe copied to your universes.",
  "universeManager.copyFailed": "Failed to copy universe.",
  "universeManager.memberName": "Name",
  "universeManager.symbol": "Symbol",
  "universeManager.weight": "Weight",
  "universeManager.summary.system": "System universes",
  "universeManager.summary.personal": "My universes",
  "universeManager.summary.coverage": "System constituents",
  "universeManager.summary.updated": "Latest data date",
  "universeManager.tabs.system": "System universes",
  "universeManager.tabs.personal": "My universes",
  "universeManager.tabs.watchlist": "Watchlist",
  "settings.universeSync.title": "System universe snapshots",
  "settings.universeSync.description": "Shared read-only universes used by all users. Synchronization validates counts and preserves effective-date history.",
  "settings.universeSync.sync": "Sync selected",
  "settings.universeSync.syncing": "Synchronizing",
  "settings.universeSync.started": "System universes updated.",
  "settings.universeSync.failed": "System universe synchronization failed.",
  "settings.universeSync.failedWithCodes": "System universe synchronization failed for: {codes}. Check the related data sources or server logs.",
  "settings.universeSync.partialWithCodes": "Some universes were updated, but these failed: {codes}.",
  "settings.universeSync.pool": "Universe",
  "settings.universeSync.members": "Constituents",
  "settings.universeSync.version": "Source version",
  "settings.universeSync.historyFrom": "History from",
  "settings.universeSync.status": "Status",
  "settings.universeSync.selectionRequired": "Select at least one universe.",
  "portfolio.mixedMarketUniverseNotSupported": "This backtest version requires one market per universe because trading calendars differ. Create separate stock and crypto universes.",
  "settings.group.market_catalog": "Market Data",
  "settings.marketCatalog.overviewTitle": "Market data overview",
  "settings.marketCatalog.description": "The catalog syncs automatically at startup. Run it again after changing the network or proxy.",
  "settings.marketCatalog.syncNow": "Sync now",
  "settings.marketCatalog.syncing": "Syncing",
  "settings.marketCatalog.started": "Market data sync started",
  "settings.marketCatalog.alreadyRunning": "A market data sync is already running",
  "settings.marketCatalog.startFailed": "Unable to start market data sync",
  "settings.marketCatalog.activeRecords": "Active records",
  "settings.marketCatalog.uniqueSymbols": "Unique symbols",
  "settings.marketCatalog.equityContracts": "Equity contracts",
  "settings.marketCatalog.rwaContracts": "RWA contracts",
  "settings.marketCatalog.venueCoverage": "Exchange coverage",
  "settings.marketCatalog.exchange": "Exchange",
  "settings.marketCatalog.spot": "Spot",
  "settings.marketCatalog.swap": "Contract",
  "settings.marketCatalog.syncResult": "Latest result",
  "settings.marketCatalog.marketOverview": "All markets",
  "settings.marketCatalog.runningDescription": "The service is pulling spot and contract catalogs from all six exchanges.",
  "settings.marketCatalog.resultDescription": "{success}/{total} sources succeeded, {rows} records written. Completed at {time}.",
  "settings.marketCatalog.status.success": "Success",
  "settings.marketCatalog.status.partial": "Partial success",
  "settings.marketCatalog.status.failed": "Failed",
  "settings.marketCatalog.status.running": "Running",
  "settings.marketCatalog.status.never": "Not synced",
  "settings.marketCatalog.failureDetails": "View failed sources"
  ,
  "strategyCenter.console.title": "Live Operations",
  "strategyCenter.console.subtitle": "Monitor status, positions, orders, and logs, and control live or notification-only strategies in one place.",
  "strategyCenter.console.systemHealthy": "System healthy",
  "strategyCenter.console.systemDegraded": "Some services degraded",
  "strategyCenter.console.emptyTitle": "No running strategies",
  "strategyCenter.console.emptyDescription": "Strategies appear here after you create them and choose an execution mode.",
  "strategyCenter.console.filterLabel": "Strategy status filters",
  "strategyCenter.console.searchPlaceholder": "Search strategy or symbol",
  "strategyCenter.console.strategyAndSymbol": "Strategy / Symbol",
  "strategyCenter.console.todayPnl": "Today's P&L",
  "strategyCenter.console.noMatches": "No matching strategies",
  "strategyCenter.console.strategyCount": "{count} strategies",
  "strategyCenter.console.startedAt": "Started",
  "strategyCenter.console.stopConfirm": "Stop this strategy?",
  "strategyCenter.console.manage": "Manage strategy",
  "strategyCenter.console.latency": "Runtime latency",
  "strategyCenter.console.equityCurve": "Equity curve",
  "strategyCenter.console.realtimeData": "Runtime data",
  "strategyCenter.console.noEquityData": "No equity data",
  "strategyCenter.console.currentPositions": "Current positions",
  "strategyCenter.console.runtimeEvents": "Runtime events",
  "strategyCenter.console.viewAll": "View all"
}

const locale = {
  "marketContext.source": "Market data",
  "marketContext.spot": "Spot",
  "marketContext.swap": "Perpetual",
  "trading-assistant.exchangeNames.htx": "HTX",
  "trading-assistant.validation.alpacaOnlyForUSStockOrCrypto": "Alpaca supports US stocks only.",
  "backtest-center.exchange": "Exchange",
  "aiAssetAnalysis.copilot.strategyPrompt.indicatorStarter": "Create a simple chart indicator for {target} that shows trend and possible reversals. Encode conservative defaults in # @param declarations and return runnable indicator code only.",
  "aiAssetAnalysis.copilot.strategyPrompt.indicatorStarterWithIdea": "Create a simple chart indicator for {target}. My idea: {idea}\nEncode missing assumptions as conservative # @param defaults and return runnable indicator code only.",
  "aiAssetAnalysis.copilot.strategyPrompt.scriptStarter": "Create an executable trading strategy for {target} with entry, exit, risk, and position-sizing rules. Encode conservative defaults in Strategy API V2 parameters and metadata; return code only.",
  "aiAssetAnalysis.copilot.strategyPrompt.scriptStarterWithIdea": "Create an executable trading strategy for {target}. My idea: {idea}\nComplete entry, exit, risk, and position rules with conservative Strategy API V2 parameters and metadata; return code only.",
  "aiAssetAnalysis.copilot.indicatorAgentArmed": "The chart indicator draft is ready. Send it now or add a preference.",
  "aiAssetAnalysis.copilot.strategyAgentArmed": "The trading strategy draft is ready. Send it now or add a preference.",
  "aiAssetAnalysis.copilot.composerGuide.ready": "Ready to send",
  "aiAssetAnalysis.copilot.composerGuide.indicator.title": "What do you want to see on the chart?",
  "aiAssetAnalysis.copilot.composerGuide.indicator.desc": "No formulas needed. Send the draft as-is, or add one or two preferences.",
  "aiAssetAnalysis.copilot.composerGuide.indicator.suggestions.trend.label": "Trend direction",
  "aiAssetAnalysis.copilot.composerGuide.indicator.suggestions.trend.prompt": "Also show the main trend direction and when it changes.",
  "aiAssetAnalysis.copilot.composerGuide.indicator.suggestions.signals.label": "Signal markers",
  "aiAssetAnalysis.copilot.composerGuide.indicator.suggestions.signals.prompt": "Mark potential entry and exit signals clearly on the chart.",
  "aiAssetAnalysis.copilot.composerGuide.indicator.suggestions.levels.label": "Key levels",
  "aiAssetAnalysis.copilot.composerGuide.indicator.suggestions.levels.prompt": "Show important support and resistance levels without covering the candles.",
  "aiAssetAnalysis.copilot.composerGuide.script.title": "How should the strategy trade?",
  "aiAssetAnalysis.copilot.composerGuide.script.desc": "No code needed. Send the draft as-is, or add the rules you care about.",
  "aiAssetAnalysis.copilot.composerGuide.script.suggestions.entry.label": "Entry rules",
  "aiAssetAnalysis.copilot.composerGuide.script.suggestions.entry.prompt": "Use clear entry conditions and avoid chasing late moves.",
  "aiAssetAnalysis.copilot.composerGuide.script.suggestions.risk.label": "Stop and profit",
  "aiAssetAnalysis.copilot.composerGuide.script.suggestions.risk.prompt": "Add conservative stop-loss and take-profit rules.",
  "aiAssetAnalysis.copilot.composerGuide.script.suggestions.position.label": "Position sizing",
  "aiAssetAnalysis.copilot.composerGuide.script.suggestions.position.prompt": "Include simple position sizing and a maximum risk per trade.",
  ...
  "menu.dashboard.aiAssetAnalysis": "AI Assistant",
  ...
  "menu.dashboard.brokerAccounts": "Account",
  "menu.dashboard.scriptStrategies": "Script",
  "menu.dashboard.strategyCenter": "Live",
  "menu.dashboard.executorStrategies": "Trading Robots",
  "executorStrategies.kicker": "Automated trading",
  "executorStrategies.title": "Trading Robots",
  "executorStrategies.subtitle": "Configure stateful grid, DCA, and martingale robots, review the execution plan, then use signal or live execution.",
  "executorStrategies.reload": "Reload",
  "executorStrategies.create": "Create robot",
  "executorStrategies.generateCode": "Generate editable code",
  "executorStrategies.generatedCode": "Editable robot strategy code generated",
  "executorStrategies.config": "Robot configuration",
  "executorStrategies.type": "Algorithm type",
  "executorStrategies.type.grid": "Grid",
  "executorStrategies.type.dca": "DCA",
  "executorStrategies.type.martingale": "Martingale",
  "executorStrategies.type.layered_martingale": "Layered Martingale",
  "executorStrategies.name": "Strategy name",
  "executorStrategies.namePlaceholder": "Optional, generated from type and symbol if empty",
  "executorStrategies.symbol": "Symbol",
  "executorStrategies.timeframe": "Timeframe",
  "executorStrategies.side": "Side",
  "executorStrategies.long": "Long",
  "executorStrategies.short": "Short",
  "executorStrategies.neutral": "Neutral",
  "executorStrategies.marketType": "Market type",
  "executorStrategies.swap": "Swap",
  "executorStrategies.spot": "Spot",
  "executorStrategies.executionMode": "Execution mode",
  "executorStrategies.signal": "Signal",
  "executorStrategies.live": "Live",
  "executorStrategies.leverage": "Leverage",
  "executorStrategies.initialCapital": "Initial capital",
  "executorStrategies.initialPositionPct": "Initial position %",
  "executorStrategies.initialPositionHint": "Position opened when a directional grid starts; neutral grids begin with zero net exposure.",
  "executorStrategies.watchlistEmpty": "No tradable symbols in the watchlist",
  "executorStrategies.startPrice": "Start price",
  "executorStrategies.endPrice": "End price",
  "executorStrategies.gridCount": "Grid count",
  "executorStrategies.maxOpenOrders": "Max open orders",
  "executorStrategies.gridMode": "Grid mode",
  "executorStrategies.arithmetic": "Arithmetic",
  "executorStrategies.geometric": "Geometric",
  "executorStrategies.entryPrice": "Entry price",
  "executorStrategies.maxLayers": "Max layers",
  "executorStrategies.layerCount": "Layer count",
  "executorStrategies.layerCountHint": "Number of independent price groups. A new group starts only after the preceding group has placed all of its child orders.",
  "executorStrategies.ordersPerLayer": "Orders per layer",
  "executorStrategies.ordersPerLayerHint": "Child orders inside each group. They share one basket average entry and one exit rule.",
  "executorStrategies.baseOrder": "Base order",
  "executorStrategies.layeredBaseOrderHint": "Allocation weight of the first child order in every group.",
  "executorStrategies.safetyOrder": "Safety order",
  "executorStrategies.stepMultiplier": "Step multiplier",
  "executorStrategies.volumeMultiplier": "Volume multiplier",
  "executorStrategies.layeredVolumeMultiplierHint": "Within each group, every later child order uses the previous order weight multiplied by this value.",
  "executorStrategies.intraSpacing1": "Intra spacing 1 %",
  "executorStrategies.intraSpacing1Hint": "Adverse price distance from child order 1 to child order 2 inside the same group.",
  "executorStrategies.intraSpacing2": "Intra spacing 2 %",
  "executorStrategies.intraSpacing2Hint": "Adverse distance between later child orders; reused when a group contains more than three orders.",
  "executorStrategies.interSpacing1": "Inter layer spacing 1 %",
  "executorStrategies.interSpacingHint": "Extra adverse distance before the next price group begins, measured from the preceding child order.",
  "executorStrategies.interSpacing2": "Inter layer spacing 2 %",
  "executorStrategies.interSpacing3": "Inter layer spacing 3 %",
  "executorStrategies.interSpacing4": "Inter layer spacing 4 %",
  "executorStrategies.totalAmount": "Total quote amount",
  "executorStrategies.takeProfitPct": "Take profit %",
  "executorStrategies.fixedTakeProfitPct": "Fixed take profit %",
  "executorStrategies.fixedTakeProfitHint": "Closes immediately when basket profit reaches this percentage.",
  "executorStrategies.fixedTakeProfitDisabledHint": "Disabled while trailing take profit is enabled, so it does not close before trailing begins.",
  "executorStrategies.trailingTakeProfit": "Trailing take profit",
  "executorStrategies.trailingTakeProfitHint": "After activation, follows the best favorable price and closes the whole basket when price pulls back by the callback percentage.",
  "executorStrategies.trailingActivationPct": "Activation profit %",
  "executorStrategies.trailingActivationHint": "Profit required before tracking starts. No trailing exit occurs before this threshold.",
  "executorStrategies.trailingCallbackPct": "Callback %",
  "executorStrategies.trailingCallbackHint": "Pullback from the best price after activation. Keep it below the activation profit.",
  "executorStrategies.priceDeviationPct": "Price deviation %",
  "executorStrategies.hardStopPct": "Hard stop %",
  "executorStrategies.preview": "Preview",
  "executorStrategies.previewTitle": "Level preview",
  "executorStrategies.summary.levels": "Levels",
  "executorStrategies.summary.amount": "Total amount",
  "executorStrategies.summary.first": "First price",
  "executorStrategies.summary.last": "Last price",
  "executorStrategies.table.level": "Level",
  "executorStrategies.table.layer": "Layer",
  "executorStrategies.table.order": "Order",
  "executorStrategies.table.action": "Action",
  "executorStrategies.table.side": "Side",
  "executorStrategies.table.price": "Price",
  "executorStrategies.table.amount": "Quote amount",
  "executorStrategies.table.takeProfit": "Take profit price",
  "executorStrategies.table.trailingActivation": "Trailing activation price",
  "executorStrategies.table.trigger": "Trigger",
  "executorStrategies.action.open": "Open",
  "executorStrategies.action.add": "Add",
  "executorStrategies.note.stateMachine": "Each algorithm owns its order state machine, including layered entries and exits.",
  "executorStrategies.note.sharedRuntime": "Signal and live modes use the same sizing, risk, and order-state contract.",
  "executorStrategies.warning.invalid_price_bounds": "Check price bounds",
  "executorStrategies.warning.missing_total_amount_quote": "Total amount is missing",
  "executorStrategies.warning.missing_entry_price": "Entry price is missing",
  "executorStrategies.warning.missing_base_order_size": "Base order is missing",
  "executorStrategies.warning.preview_failed": "Preview failed",
  "executorStrategies.warning.invalid_trailing_take_profit": "Trailing callback must be greater than 0 and smaller than the activation profit",
  "executorStrategies.createSuccess": "Trading robot created",
  "executorStrategies.createFailed": "Failed to create trading robot",
  "executorStrategies.model.controller": "Controller",
  "executorStrategies.model.controllerDesc": "Defines intent, boundaries, and risk rules.",
  "executorStrategies.model.executor": "Algorithm runtime",
  "executorStrategies.model.executorDesc": "Owns order creation, refresh, fills, and exits.",
  "executorStrategies.model.tracker": "Order tracker",
  "executorStrategies.model.trackerDesc": "Persists status, PnL, and runtime recovery state.",
  "executorStrategies.catalog": "Robot types",
  "executorStrategies.supported": "Supported",
  "executorStrategies.reference": "Reference",
  "executorStrategies.catalog.grid": "Range market making with level-based take profit.",
  "executorStrategies.catalog.dca": "Layered accumulation with explicit prices and quote amounts.",
  "executorStrategies.catalog.martingale": "DCA variant with aggressive volume scaling.",
  "executorStrategies.catalog.layered_martingale": "Groups entries into price zones; each group scales several child orders and exits the combined basket from its average cost.",
  "executorStrategies.layeredExplainerTitle": "How layered martingale works",
  "executorStrategies.layeredExplainerDesc": "Current plan: {layers} price groups × {orders} child orders = {total} entries at most. Orders scale inside a group; inter-group spacing delays the next group. All filled orders share basket-average exit protection.",
  "executorStrategies.catalog.position": "Single position with triple-barrier exits.",
  "executorStrategies.catalog.twap": "Split a large order across time slices.",
  "executorStrategies.catalog.xemm": "Cross-exchange market making executor.",
  "executorStrategies.catalog.arbitrage": "Two-market arbitrage executor.",
  "executorStrategies.catalog.lp": "Liquidity provision executor.",
  ...
  "executorStrategies.section.market": "Market",
  "executorStrategies.section.capitalRisk": "Capital and risk",
  "executorStrategies.section.executor": "Algorithm plan",
  "executorStrategies.minSpread": "Min spread %",
  "executorStrategies.advanced": "Advanced runtime settings",
  "executorStrategies.samplingInterval": "Sampling interval",
  "executorStrategies.flow.choose": "Choose template",
  "executorStrategies.flow.configure": "Configure",
  "executorStrategies.flow.generate": "Review and generate",
  "executorStrategies.compatibility.title": "Engine compatibility",
  "executorStrategies.compatibility.subtitle": "One Strategy API V2 source powers the complete workflow",
  "executorStrategies.compatibility.strategy": "Strategy editor",
  "executorStrategies.compatibility.strategyDesc": "Continue editing and save after generation",
  "executorStrategies.compatibility.backtest": "Backtest engine",
  "executorStrategies.compatibility.backtestDesc": "Uses the V2 bar runtime and execution ledger",
  "executorStrategies.compatibility.live": "Live engine",
  "executorStrategies.compatibility.liveDesc": "Bind a trading account after saving to run live",
  "executorStrategies.compatibility.ready": "Ready",
  "executorStrategies.compatibility.badge": "Strategy API V2",
  "executorStrategies.neutralUnsupported": "The current V2 position model does not support hedged neutral grids",
  "executorStrategies.validation.ready": "Parameters passed validation and the strategy is ready to generate",
  "executorStrategies.validation.check": "Complete the required parameters first",
  "executorStrategies.validation.symbol": "Select a symbol",
  "executorStrategies.validation.neutral": "Neutral grid is not supported by the current engine",
  "executorStrategies.validation.priceBounds": "Start and end prices must be valid and different",
  "executorStrategies.validation.amount": "Total quote amount must be greater than zero",
  "executorStrategies.validation.entryPrice": "Entry price must be greater than zero",
  "executorStrategies.validation.baseOrder": "Base order must be greater than zero",
  "executorStrategies.validation.credential": "Live mode requires a saved trading account",
  "executorStrategies.validation.trailingTakeProfit": "Trailing callback must be greater than 0 and smaller than activation profit",
  "strategyCenter.title": "Live Monitor",
  "strategyCenter.subtitle": "Monitor script strategies, strategy scripts, and templates in one place: live status, positions, and PnL",
  "strategyCenter.card.signal.badge": "No code",
  "strategyCenter.card.signal.title": "Strategy API V2",
  "strategyCenter.card.signal.desc": "Pick an indicator and bind an account to run signals or live trading",
  "strategyCenter.card.signal.suit": "Best for: Python Strategy API V2 with ctx order methods",
  "strategyCenter.card.signal.action": "Create Strategy API V2",
  "strategyCenter.card.signal.secondary": "No indicator yet? Open Indicator IDE →",
  "strategyCenter.card.script.badge": "Python",
  "strategyCenter.card.script.title": "Strategy API V2",
  "strategyCenter.card.script.desc": "Bar-by-bar Python execution for stateful logic",
  "strategyCenter.card.script.suit": "Best for: trailing stops, scale-in, cross-bar memory",
  "strategyCenter.card.script.action": "Create Strategy API V2",
  "strategyCenter.card.bot.badge": "Template",
  "strategyCenter.card.bot.title": "Template Strategy",
  "strategyCenter.card.bot.desc": "Grid / DCA / Martingale / Trend — fill parameters only",
  "strategyCenter.card.bot.suit": "Best for: common patterns without writing from scratch",
  "strategyCenter.card.bot.action": "Create template strategy",
  "strategyCenter.tabs.library": "My library",
  "strategyCenter.tabs.overview": "Live overview",
  "strategyCenter.tabs.workspace": "Workspace",
  "strategyCenter.tabs.backtestHistory": "Backtest history",
  "strategyCenter.header.badge": "Live monitoring & strategy lists",
  "strategyCenter.header.createStrategyV2": "Create trading script",
  "strategyCenter.header.createBot": "Create template strategy",
  "strategyCenter.header.openIde": "Strategy Chart Workbench",
  "strategyCenter.workspace.manageTitle": "Quick links",
  "strategyCenter.tabs.backtest": "Backtest",
  "strategyCenter.library.indicatorStrategies": "Strategy API V2 deployments",
  "strategyCenter.library.scriptStrategies": "Strategy API V2 deployments",
  "strategyCenter.library.bots": "Template strategies",
  "strategyCenter.library.marketplace": "Strategy Market",
  "strategyCenter.stats.ownIndicators": "Own indicators",
  "strategyCenter.stats.runningTotal": "Running {running} / Total {total}",
  "strategyCenter.stats.createLive": "Create live",
  "strategyCenter.stats.ownStrategies": "Own strategies",
  "strategyCenter.stats.indicatorStrategy": "Strategy API V2 deployments",
  "strategyCenter.stats.script": "Script",
  "strategyCenter.stats.bot": "Template strategies",
  "strategyCenter.stats.running": "Running",
  "strategyCenter.flowHintTitle": "Recommended path",
  "strategyCenter.flowHintDesc": "Indicators are chart-only; use Strategy API V2 for custom execution, and use dedicated executors for grid, DCA, and martingale workflows.",
  "strategyCenter.backtest.run": "Run backtest",
  "strategyCenter.backtest.panelTitle": "Strategy backtest",
  "strategyCenter.backtest.quickRange": "Quick range",
  ...
  "strategyCenter.backtest.emptyResultTitle": "No backtest yet",
  "strategyCenter.backtest.emptyResultDesc": "Pick a date range and run backtest — results appear here.",
  "strategyCenter.backtest.noHistory": "No backtest history",
  "strategyCenter.backtest.records": "records",
  "strategyCenter.backtest.payoffRatio": "Payoff Ratio",
  "strategyCenter.backtest.averageProfit": "Average P&L",
  "strategyCenter.backtest.worstTrade": "Worst Trade",
  "strategyCenter.backtest.bestTrade": "Best Trade",
  "strategyCenter.backtest.losingTrades": "Losing Trades",
  "strategyCenter.backtest.winningTrades": "Winning Trades",
  "strategyCenter.backtest.profitDistribution": "P&L Distribution",
  "strategyCenter.backtest.equityCurve": "Equity Curve",
  "strategyCenter.backtest.alphaReturn": "Alpha",
  "strategyCenter.backtest.spotBenchmark": "Spot Buy & Hold",
  "strategyCenter.backtest.strategyEquity": "Strategy Equity",
  "strategyCenter.backtest.tunerMethodBayes": "Bayesian",
  "strategyCenter.backtest.tunerMethodDe": "Differential evolution",
  "strategyCenter.backtest.tunerMethodRandom": "Random",
  "strategyCenter.backtest.tunerMethodGrid": "Grid",
  "strategyCenter.backtest.tradeTypeReduceLong": "Reduce long",
  "strategyCenter.backtest.tradeTypeAddLong": "Add long",
  "strategyCenter.backtest.tradeTypeCloseShort": "Close short",
  "strategyCenter.backtest.tradeTypeOpenShort": "Open short",
  "strategyCenter.backtest.tradeTypeCloseLong": "Close long",
  "strategyCenter.backtest.tradeTypeOpenLong": "Open long",
  "strategyCenter.backtest.tunerTitle": "Smart Tuner",
  "strategyCenter.backtest.tunerDesc": "Search strategy parameters automatically, then apply the best candidate after review.",
  "strategyCenter.backtest.tunerObjectiveBalanced": "Balanced",
  "strategyCenter.backtest.tunerObjectiveAlpha": "Beat spot",
  "strategyCenter.backtest.tunerObjectiveDrawdown": "Low drawdown",
  "strategyCenter.backtest.tunerObjectiveReturn": "Return first",
  "strategyCenter.backtest.runTuner": "Run",
  "strategyCenter.backtest.tunableDimensions": "Tunable Dimensions",
  "strategyCenter.backtest.tunableParams": "tunable params",
  "strategyCenter.backtest.tuneCandidates": "candidates",
  "strategyCenter.backtest.tuneProgress": "Tuning {done}/{total}",
  "strategyCenter.backtest.tuneRank": "Rank",
  "strategyCenter.backtest.tuneScore": "Score",
  "strategyCenter.backtest.tuneParams": "Params",
  "strategyCenter.backtest.applyTuneParams": "Apply to code",
  "strategyCenter.backtest.tuneBaseCandidate": "Current params",
  "strategyCenter.backtest.tuneAggressiveCandidate": "Combined boost",
  "strategyCenter.backtest.tuneApplied": "Params applied to code. Review and save when ready.",
  "strategyCenter.backtest.tuneNoParams": "No tunable numeric params found in this script",
  "strategyCenter.backtest.tuneSuccess": "Tuning complete. Best candidate selected.",
  "strategyCenter.backtest.tuneNoResult": "No valid tuning result returned",
  "strategyCenter.backtest.tuneFailed": "Tuning failed",
  "strategyCenter.backtest.statusSuccess": "Success",
  "strategyCenter.backtest.statusFailed": "Failed",
  "strategyCenter.backtest.colStatus": "Status",
  "strategyCenter.backtest.refreshHistory": "Refresh history",
  "strategyCenter.backtest.startDate": "Start",
  "strategyCenter.backtest.endDate": "End",
  "strategyCenter.backtest.totalReturn": "Total return",
  "strategyCenter.backtest.maxDrawdown": "Max drawdown",
  "strategyCenter.backtest.sharpe": "Sharpe",
  "strategyCenter.backtest.winRate": "Win rate",
  "strategyCenter.backtest.trades": "Trades",
  "strategyCenter.backtest.historyTitle": "Strategy backtest history",
  "strategyCenter.backtest.success": "Backtest completed",
  "strategyCenter.backtest.failed": "Backtest failed",
  "strategyCenter.backtest.running": "Running backtest…",
  "strategyCenter.backtest.noStrategy": "Select a strategy first",
  "strategyCenter.backtest.dateRequired": "Select a date range",
  "strategyCenter.backtest.colDate": "Time",
  "strategyCenter.backtest.colRange": "Range",
  "strategyCenter.backtest.colReturn": "Return",
  "strategyCenter.backtest.colType": "Type",
  "strategyCenter.backtest.typeIndicator": "Script strategy",
  "strategyCenter.backtest.typeScript": "Script strategy",
  "strategyCenter.backtest.typeIde": "Indicator IDE",
  "strategyCenter.backtest.botHintTitle": "Template strategy backtest note",
  "strategyCenter.backtest.botHintDesc": "Template strategies run on script templates; results are bar-replay simulations and may differ from live resting-order engines (e.g. grid).",
  "strategyCenter.backtest.colAction": "Action",
  "strategyCenter.backtest.viewDetail": "View details",
  "strategyCenter.backtest.tradeDetails": "Trade details",
  "strategyCenter.backtest.viewTrades": "View trades",
  "strategyCenter.backtest.noTrades": "No trades in this backtest run",
  "strategyCenter.backtest.loadDetailFailed": "Failed to load backtest details",
  "strategyCenter.backtest.detailOnlySuccess": "Only successful runs have trade details",
  "strategyCenter.backtest.tradeTime": "Time",
  "strategyCenter.backtest.tradeType": "Type",
  "strategyCenter.backtest.tradePrice": "Price",
  "strategyCenter.backtest.tradeAmount": "Amount",
  "strategyCenter.backtest.tradeProfit": "P/L",
  "strategyCenter.backtest.tradeBalance": "Balance",
  "trading-bot.cloneAsScript.gridPlaceholderHint": "Grid bots execute via the live resting-order engine; the cloned script is only a placeholder (handle_data: pass). Rewrite handle_data in Strategy Studio for custom logic, or clone a martingale/trend/DCA bot for a full template.",
  "strategyCenter.history.filterType": "Filter by type",
  "strategyCenter.history.colName": "Name",
  "strategyCenter.history.colSymbol": "Symbol",
  "strategyCenter.history.colReturn": "Return",
  "strategyCenter.history.colType": "Type",
  "strategyCenter.history.colDate": "Time",
  "strategyCenter.lifecycle.verified": "Verified",
  "strategyCenter.lifecycle.unverified": "Not verified",
  "strategyCenter.lifecycle.backtested": "Backtested",
  "strategyCenter.lifecycle.notBacktested": "Not backtested",
  "strategyCenter.live.noBacktestTitle": "No backtest yet",
  "strategyCenter.live.noBacktestContent": "This Strategy API V2 has no successful backtest. Run a backtest first, or start live anyway?",
  "strategyCenter.live.startAnyway": "Start anyway",
  "strategyCenter.live.goBacktest": "Backtest first",
  "strategyCenter.publish.action": "Publish to marketplace",
  "strategyCenter.publish.title": "Publish strategy template",
  "strategyCenter.publish.name": "Template name",
  "strategyCenter.publish.description": "Description",
  "strategyCenter.publish.pricingType": "Pricing",
  "strategyCenter.publish.price": "Price (credits)",
  "strategyCenter.publish.success": "Submitted for review. It will appear under Strategy templates once approved.",
  "strategyCenter.publish.failed": "Publish failed",
  "community.tabIndicators": "Indicators",
  "community.tabScriptTemplates": "Strategies",
  "community.tabBotPresets": "Template strategies",
  "community.scriptTemplatesEmpty": "No published scripts yet",
  "community.botPresetsEmpty": "No template strategies yet. Create a template strategy, then publish it to the marketplace.",
  "trading-assistant.backtestInIde": "Backtest in Indicator IDE",
  "community.createBotPreset": "Create template strategy",
  "community.useBotPreset": "Configure & use",
  "community.botPresetPurchased": "Purchase complete. A template strategy instance was created — bind an account before starting Live.",
  "community.botPresetInfo": "About this template strategy",
  "community.botPresetUseHint": "After purchase, parameter defaults are copied to your account. Choose credentials and symbol, save, then start Live.",
  "community.useStrategyV2": "Open strategy",
  "community.useNow": "Use Now",
  "community.free": "Free",
  "community.paidOnly": "Paid",
  "community.scriptTemplatePurchased": "Added to script strategies — edit and backtest from the script page",
  "community.purchaseSuccess": "Purchase successful! Indicator added to your list",
  "trading-bot.pageTitle": "Template Strategies",
  "trading-bot.pageSubtitle": "Create and manage your template strategies",
  "trading-bot.backToList": "Back to list",
  "trading-bot.createNew": "Create New Template Strategy",
  "trading-bot.createNewDesc": "Pick a strategy type to quickly create your template strategy",
  "trading-bot.myBots": "My Template Strategies",
  "trading-bot.searchBot": "Search template strategy name or pair",
  "trading-bot.allStatus": "All statuses",
  "trading-bot.noBots": "No template strategies yet — pick a card above to create one",
  ...
  "trading-bot.action.publishToMarket": "Publish to market",
  "trading-bot.action.openMarketplace": "Browse template strategy market",
  "trading-bot.publish.title": "Publish template strategy",
  "trading-bot.publish.name": "Preset name",
  "trading-bot.publish.description": "Description",
  "trading-bot.publish.pricingType": "Pricing",
  "trading-bot.publish.price": "Price (credits)",
  "trading-bot.publish.hint": "Only parameter templates are published (no API keys). After review, it appears under Strategy Market → Template strategies.",
  "trading-bot.publish.defaultDescription": "Template strategy parameters based on {type}",
  "trading-bot.publish.success": "Submitted for review. It will appear under Template strategies once approved.",
  "trading-bot.publish.failed": "Publish failed",
  "trading-bot.cloneAsScript.tooltip": "Clone this bot as an editable Python Strategy API V2",
  "trading-bot.cloneAsScript.noCode": "This bot has no code to clone",
  "trading-bot.cloneAsScript.confirmTitle": "Clone as Strategy API V2",
  "trading-bot.cloneAsScript.confirmContent": "Clone \"{name}\" as an editable Python Strategy API V2? The new strategy will start in signal-only mode and will not auto-trade live.",
  ...
  "trading-bot.cloneAsScript.successTitle": "Cloned as Strategy API V2",
  ...
  "trading-bot.advanced.scriptEntry.linkText": "Write a Python Strategy API V2",
  ...
  "trading-bot.detail.restingPurpose.grid_initial_long": "Initial long position",
  "trading-bot.detail.restingPurpose.grid_initial_short": "Initial short position",
  ...
  "trading-bot.wizard.createTitle": "Create {type} template strategy",
  ...
  "trading-bot.wizard.manageCredentials": "Manage broker accounts",
  ...
  "trading-bot.wizard.futuresUnsupported": "This account does not support futures. Switch to spot or choose another account.",
  "trading-bot.wizard.basicConfigIncomplete": "Please complete the basic configuration first.",
  "trading-bot.wizard.strategyParamsIncomplete": "Please complete the strategy parameters first.",
  ...
  "trading-bot.wizard.create": "Create template strategy",
  "trading-bot.wizard.save": "Save Changes",
  "trading-bot.wizard.createSuccess": "Template strategy created successfully!",
  "trading-bot.wizard.createFail": "Failed to create template strategy, please retry",
  ...
  "trading-bot.risk.equityTakeProfitPct": "Equity Take Profit (%)",
  "trading-bot.risk.gridOobBufferPct": "Out-of-Grid Buffer (%)",
  "trading-bot.risk.tickIntervalSec": "Loop Interval (sec)",
  ...
  "trading-bot.ai.dialogTitle": "AI Template Strategy Creator",
  ...
  "aiAssetAnalysis.title": "AI Smart Analysis",
  ...
  "aiAssetAnalysis.copilot.monitorMissingSymbol": "I can create an AI scheduled analysis task, but no symbol is selected. Choose a data context or mention a symbol like Crypto:BTC/USDT.",
  "aiAssetAnalysis.copilot.strategyMissingSymbol": "I classified this as a strategy creation task, but the target symbol is missing. Please provide a symbol such as `Crypto:BTC/USDT`, `USStock:SPCX`, or `CNStock:300750`.",
  "aiAssetAnalysis.copilot.strategySymbolPlaceholder": "[enter symbol here, e.g. Crypto:BTC/USDT or CNStock:300750]",
  "aiAssetAnalysis.copilot.missingSymbolMeta": "missing symbol",
  "aiAssetAnalysis.copilot.title": "AI Copilot",
  "aiAssetAnalysis.copilot.subtitle": "Search symbols, inspect events, analyze markets, diagnose strategies, and draft code from one workspace.",
  "aiAssetAnalysis.copilot.sessions": "Chat History",
  "aiAssetAnalysis.copilot.newChat": "New",
  "aiAssetAnalysis.copilot.noSessions": "No conversations yet",
  "aiAssetAnalysis.copilot.chatSession": "AI chat",
  "aiAssetAnalysis.copilot.untitled": "New conversation",
  "aiAssetAnalysis.copilot.calendar": "Market Calendar",
  "aiAssetAnalysis.copilot.highImpact": "High impact",
  "aiAssetAnalysis.copilot.today": "Today",
  "aiAssetAnalysis.copilot.all": "All",
  "aiAssetAnalysis.copilot.loading": "Loading...",
  "aiAssetAnalysis.copilot.noEvents": "No upcoming events",
  "aiAssetAnalysis.copilot.focusSymbol": "Symbol to analyze",
  "aiAssetAnalysis.copilot.symbol": "Symbol",
  "aiAssetAnalysis.copilot.symbolPlaceholder": "Not fixed; AI will infer from your message",
  "aiAssetAnalysis.copilot.contextAutoInfer": "Not fixed; AI will infer from your message",
  "aiAssetAnalysis.copilot.noSymbol": "No symbol selected",
  "aiAssetAnalysis.copilot.estimatedCost": "Estimated cost",
  "aiAssetAnalysis.copilot.scheduleCurrent": "Schedule analysis",
  "aiAssetAnalysis.copilot.welcomeTitle": "Control QuantDinger with plain language",
  "aiAssetAnalysis.copilot.welcomeDesc": "Ask about markets, explain logs, draft strategies, or attach a chart screenshot.",
  "aiAssetAnalysis.copilot.placeholder": "Example: diagnose BTC/USDT 1H trend, or upload a chart screenshot and ask whether entry risk is acceptable...",
  "aiAssetAnalysis.copilot.uploadChart": "Upload image",
  "aiAssetAnalysis.copilot.send": "Send",
  "aiAssetAnalysis.copilot.watchlist": "Watchlist",
  "aiAssetAnalysis.copilot.addWatchPlaceholder": "Add symbol, e.g. BTC/USDT or AAPL",
  "aiAssetAnalysis.copilot.addWatch": "Add to watchlist",
  "aiAssetAnalysis.copilot.addWatchTitle": "Add to watchlist",
  "aiAssetAnalysis.copilot.addWatchSearchPlaceholder": "Search or enter a symbol",
  "aiAssetAnalysis.copilot.addWatchEmptyHint": "Enter a symbol to add it.",
  "aiAssetAnalysis.copilot.search": "Search",
  "aiAssetAnalysis.copilot.selected": "Selected",
  "aiAssetAnalysis.copilot.add": "Add",
  "aiAssetAnalysis.copilot.noWatchlist": "No symbols yet",
  "aiAssetAnalysis.copilot.ask": "Ask",
  "aiAssetAnalysis.copilot.schedule": "Schedule",
  "aiAssetAnalysis.copilot.remove": "Remove",
  "aiAssetAnalysis.copilot.removeWatchConfirm": "Remove this symbol from watchlist?",
  "aiAssetAnalysis.copilot.monitors": "AI Scheduled Analysis",
  "aiAssetAnalysis.copilot.noMonitors": "No scheduled tasks",
  "aiAssetAnalysis.copilot.running": "Running",
  "aiAssetAnalysis.copilot.paused": "Paused",
  "aiAssetAnalysis.copilot.eventDetail": "Event detail",
  "aiAssetAnalysis.copilot.eventMetaSeparator": "·",
  "aiAssetAnalysis.copilot.impactHigh": "High impact",
  "aiAssetAnalysis.copilot.impactMedium": "Medium impact",
  "aiAssetAnalysis.copilot.impactLow": "Low impact",
  "aiAssetAnalysis.copilot.actual": "Actual",
  "aiAssetAnalysis.copilot.forecast": "Forecast",
  "aiAssetAnalysis.copilot.previous": "Previous",
  "aiAssetAnalysis.copilot.aiPreview": "AI Preview",
  "aiAssetAnalysis.copilot.askAiEvent": "Ask AI about this event",
  "aiAssetAnalysis.copilot.close": "Close",
  "aiAssetAnalysis.copilot.createMonitor": "Create scheduled analysis",
  "aiAssetAnalysis.copilot.interval": "Interval",
  "aiAssetAnalysis.copilot.notify": "Notify",
  ...
  "aiAssetAnalysis.copilot.monitorTip": "AI will re-check this symbol on schedule and keep a record.",
  "aiAssetAnalysis.copilot.monitorQuestion": "I can create an AI scheduled diagnosis task for **{label}**.\n\nThis task only runs the standard AI symbol diagnosis on a fixed schedule. Please provide:\n1. Interval: 15m / 30m / 1h / 4h / daily\n2. Notification: browser / email / telegram / webhook / record only\n\nYou can send them like this:\nInterval: 1h\nNotification: browser",
  "aiAssetAnalysis.copilot.monitorDraft": "## AI Scheduled Diagnosis Draft\n\n- Symbol: {symbol}\n- Interval: {interval}\n- Notification: {notification}\n\nThe task will run the standard AI symbol diagnosis on schedule. Click the action below to create it.",
  "aiAssetAnalysis.copilot.monitorStillMissing": "Received: {received}\n\nStill missing: {items}.\n\nSend the missing items and I will prepare the task draft.",
  "aiAssetAnalysis.copilot.monitorMissingInterval": "interval",
  "aiAssetAnalysis.copilot.monitorMissingNotification": "notification",
  "aiAssetAnalysis.copilot.monitorMissingFocus": "focus conditions",
  "aiAssetAnalysis.copilot.monitorWaitingMeta": "waiting for task parameters",
  "aiAssetAnalysis.copilot.monitorIncompleteMeta": "incomplete parameters",
  "aiAssetAnalysis.copilot.monitorReadyMeta": "ready to create",
  "aiAssetAnalysis.copilot.monitorCreateAction": "Create task",
  "aiAssetAnalysis.copilot.monitorNoNotify": "record only",
  "aiAssetAnalysis.copilot.monitorDefaultFocus": "Run the standard AI symbol diagnosis.",
  "aiAssetAnalysis.copilot.monitorReceivedInterval": "interval {interval}",
  "aiAssetAnalysis.copilot.monitorReceivedNotification": "notification {notification}",
  "aiAssetAnalysis.copilot.monitorReceivedFocus": "standard AI diagnosis selected",
  "aiAssetAnalysis.copilot.monitorReceivedNone": "nothing yet",
  "aiAssetAnalysis.copilot.monitorCreatedMessage": "AI scheduled diagnosis task created:\n\n- Symbol: {symbol}\n- Interval: {interval}\n- Notifications: {notification}\n\nYou can pause, delete, or inspect it in the AI Scheduled Analysis panel.",
  "aiAssetAnalysis.copilot.monitorCreatedMeta": "task created",
  "aiAssetAnalysis.copilot.save": "Save",
  "aiAssetAnalysis.copilot.cancel": "Cancel",
  "aiAssetAnalysis.copilot.addWatchSuccess": "Added to watchlist",
  "aiAssetAnalysis.copilot.addWatchFailed": "Failed to add symbol",
  "aiAssetAnalysis.copilot.removeWatchSuccess": "Removed from watchlist",
  "aiAssetAnalysis.copilot.removeWatchFailed": "Failed to remove symbol",
  "aiAssetAnalysis.copilot.deleteSessionConfirm": "Delete this conversation?",
  "aiAssetAnalysis.copilot.sessionDeleted": "Conversation deleted",
  "aiAssetAnalysis.copilot.sessionDeleteFailed": "Failed to delete conversation",
  "aiAssetAnalysis.copilot.monitorCreated": "Scheduled analysis created",
  "aiAssetAnalysis.copilot.monitorUpdated": "Scheduled analysis updated",
  "aiAssetAnalysis.copilot.monitorDeleted": "Scheduled analysis deleted",
  "aiAssetAnalysis.copilot.strategyFlowTitle": "Choose the strategy type to create",
  ...
  "aiAssetAnalysis.copilot.scriptStrategy": "Strategy API V2",
  "aiAssetAnalysis.copilot.scriptStrategyDesc": "Generate Python Strategy API V2 for complex logic and automated execution.",
  "aiAssetAnalysis.copilot.tradingBot": "Template Strategy",
  "aiAssetAnalysis.copilot.tradingBotDesc": "Recommend grid, trend, DCA, or martingale template parameters from market context.",
  "aiAssetAnalysis.copilot.analysisRunning": "Analysis is running...",
  "aiAssetAnalysis.copilot.analysisComplete": "Analysis complete",
  "aiAssetAnalysis.copilot.indicatorGenerated": "Indicator draft generated",
  "aiAssetAnalysis.copilot.strategyGenerated": "Strategy draft generated",
  "aiAssetAnalysis.copilot.openIndicatorIde": "Open Indicator editor",
  "aiAssetAnalysis.copilot.openTargetPage": "Open target page",
  "aiAssetAnalysis.copilot.chatUnavailable": "Chat API is not connected. Showing local fallback response first.",
  "aiAssetAnalysis.copilot.thinking": "Thinking...",
  "aiAssetAnalysis.copilot.selectSymbolFirst": "Choose a symbol to analyze before running this tool.",
  "aiAssetAnalysis.copilot.uploadImage": "Upload image",
  "aiAssetAnalysis.copilot.quickTools": "Quick tools",
  "aiAssetAnalysis.copilot.usedThisTurn": "Used this turn",
  "aiAssetAnalysis.copilot.rememberPreference": "Remember this preference",
  "aiAssetAnalysis.copilot.hideQuickTools": "Hide quick tools",
  "aiAssetAnalysis.copilot.imageAttachment": "Image attachment",
  "aiAssetAnalysis.copilot.currentSymbol": "this symbol",
  "aiAssetAnalysis.copilot.quickTasks.market_diagnosis.label": "Diagnose symbol",
  "aiAssetAnalysis.copilot.quickTasks.market_diagnosis.desc": "Trend, momentum, support/resistance, liquidity, and risk.",
  "aiAssetAnalysis.copilot.quickTasks.chart_review.label": "Chart review",
  "aiAssetAnalysis.copilot.quickTasks.chart_review.desc": "Judge entries, stops, take profit, and invalidation from a chart image.",
  "aiAssetAnalysis.copilot.quickTasks.indicator_strategy.label": "Chart Indicator",
  "aiAssetAnalysis.copilot.quickTasks.indicator_strategy.desc": "Generate chart-only indicator research with plots, markers, and parameters.",
  "aiAssetAnalysis.copilot.quickTasks.indicator_research.label": "Create chart indicator",
  "aiAssetAnalysis.copilot.quickTasks.indicator_research.desc": "Tell AI what you want to see; it will create an adjustable chart indicator.",
  "aiAssetAnalysis.copilot.quickTasks.strategy_research.label": "Create trading strategy",
  "aiAssetAnalysis.copilot.quickTasks.strategy_research.desc": "Describe an entry idea; AI completes the rules and risk controls.",
  "aiAssetAnalysis.copilot.quickTasks.scheduled_analysis.label": "Scheduled tracking",
  "aiAssetAnalysis.copilot.quickTasks.scheduled_analysis.desc": "Review watchlist changes on a schedule and save results.",
  "aiAssetAnalysis.copilot.quickTasks.news_research.label": "News / event research",
  "aiAssetAnalysis.copilot.quickTasks.news_research.desc": "Search company, asset, macro, and industry news to build usable research context.",
  "aiAssetAnalysis.copilot.quickTasks.macro_economic_data.label": "Macro data",
  "aiAssetAnalysis.copilot.quickTasks.macro_economic_data.desc": "Query CPI, FOMC, rates, GDP, PCE, and other macro events.",
  "aiAssetAnalysis.copilot.quickTasks.trade_plan.label": "Trading plan",
  "aiAssetAnalysis.copilot.quickTasks.trade_plan.desc": "Turn the current market context into a concrete execution checklist.",
  "aiAssetAnalysis.copilot.quickTasks.opportunity_radar.label": "Opportunity radar",
  "aiAssetAnalysis.copilot.quickTasks.opportunity_radar.desc": "Scan likely opportunities over the next 24 hours.",
  "aiAssetAnalysis.copilot.quickPrompts.diagnose": "Diagnose {symbol}: trend, momentum, support/resistance, liquidity, and risk.",
  "aiAssetAnalysis.copilot.quickPrompts.strategy": "Create a strategy research plan for {symbol}, including entry/exit logic, risk controls, and validation steps.",
  "aiAssetAnalysis.copilot.quickPrompts.logs": "Help me inspect strategy, bot, or API logs and identify likely causes and fixes.",
  ...
  "aiAssetAnalysis.copilot.quickPrompts.chart": "I will paste or upload a chart image. Judge whether the setup is tradable and give stop loss, take profit, and invalidation.",
  "aiAssetAnalysis.copilot.quickPrompts.monitor": "Create a scheduled analysis task for {symbol}: track trend changes, risks, and key levels.",
  "aiAssetAnalysis.copilot.quickPrompts.tradePlan": "Create an executable trading plan for {symbol}: directional bias, key levels, entry trigger, stop loss, take profit, position sizing, and when to stay out.",
  "aiAssetAnalysis.copilot.quickPrompts.news": "Search recent news and events for {symbol}; separate facts, interpretation, and uncertainty.",
  "aiAssetAnalysis.copilot.quickPrompts.macro": "Review macro data such as CPI, FOMC, rates, GDP, and PCE, and explain the market impact.",
  "aiCopilot.preflight.title": "Setup Check",
  "aiCopilot.preflight.blockersIntro": "These items need attention before the AI workflow can run:",
  "aiCopilot.preflight.recommendedNext": "Recommended next:",
  "aiCopilot.preflight.taskContinue": "You can still discuss strategy ideas, but complete the items above before code generation, analysis, or task creation.",
  "aiCopilot.preflight.meta": "setup preflight",
  "aiCopilot.preflight.creditsTitle": "Insufficient credits",
  "aiCopilot.preflight.creditsMessage": "You do not have enough credits to run AI analysis or strategy generation. Top up credits to continue.",
  "aiCopilot.preflight.configureAction": "Configure",
  "aiCopilot.preflight.openAction": "Open",
  ...
  "notice.type.indicatorSignal": "Indicator Signal",
  "notice.event.login.title": "QuantDinger login alert · {reason}",
  "notice.event.login.field.account": "Account",
  "notice.event.login.field.method": "Method",
  "notice.event.login.field.device": "Device",
  "notice.event.login.field.location": "Location",
  "notice.event.login.field.ip": "IP",
  "notice.event.login.severity": "Review",
  ...
  "notice.event.login.reason.unknown": "Unusual sign-in",
  "notice.event.login.line.account": "Account {name} signed in from a new environment.",
  "notice.event.login.line.method": "Method: {method}",
  "notice.event.login.method.password": "Password login",
  "notice.event.login.method.code": "Email code login",
  "notice.event.login.method.oauth": "{provider} login",
  "notice.event.login.line.device": "Device: {device}",
  "notice.event.login.line.location": "Location: {location}",
  ...
  "notice.event.signal.line.strategy": "Strategy: {name} (#{id})",
  "notice.event.signal.line.symbol": "Symbol: {symbol}",
  "notice.event.signal.line.signal": "Signal: {signal}",
  "notice.event.signal.line.price": "Price: {price}",
  "notice.event.signal.line.stake": "Stake: {stake}",
  "notice.event.signal.line.pending": "Pending order: {id}",
  "notice.event.signal.line.mode": "Mode: {mode}",
  "notice.event.signal.line.time": "{label}: {time}",
  "notice.event.signal.timeLabel": "Time",
  "notice.event.signal.kicker": "Strategy signal",
  "notice.event.signal.field.strategy": "Strategy",
  "notice.event.signal.field.symbol": "Symbol",
  "notice.event.signal.field.signal": "Signal",
  "notice.event.signal.field.price": "Reference price",
  "notice.event.signal.field.stake": "Stake",
  "notice.event.signal.field.pending": "Pending order",
  "notice.event.signal.field.mode": "Mode",
  "notice.event.indicatorSignal.title": "Indicator signal: {name}",
  "notice.event.indicatorSignal.kicker": "Indicator signal",
  "notice.event.indicatorSignal.field.indicator": "Indicator",
  "notice.event.indicatorSignal.field.signal": "Signal",
  "notice.event.indicatorSignal.field.symbol": "Symbol",
  "notice.event.indicatorSignal.field.timeframe": "Timeframe",
  "notice.event.indicatorSignal.field.price": "Trigger price",
  "notice.event.indicatorSignal.field.signalBar": "Signal candle",
  "notice.event.indicatorSignal.field.notifyBar": "Notification candle",
  "notice.event.indicatorSignal.note": "Confirmed on a closed candle and delivered on the next candle.",
  ...
  "user.security.verifyTitle": "Security verification",
  "user.security.verifyDesc": "Complete the verification to continue.",
  "user.security.verificationFailed": "Security verification failed. Check Turnstile configuration or try again later.",
  "user.security.loadFailed": "Security verification failed to load. Please refresh and try again.",
  ...
  "menu.group.aiWorkspace": "AI Workspace",
  "menu.group.marketData": "Market & Data",
  "menu.group.strategyLab": "Strategy Lab",
  "menu.group.autoTrading": "Auto Trading",
  "menu.group.account": "Account",
  "menu.group.admin": "Admin",
  "profile.credits.rechargeShort": "Top Up",
  ...
  "dashboard.analysis.modal.addStock.example.USStock": "e.g. AAPL, MSFT, NVDA",
  "dashboard.analysis.modal.addStock.example.CNStock": "e.g. 600519, 000001, 300750",
  "dashboard.analysis.modal.addStock.example.HKStock": "e.g. 00700, 09988, 03690",
  "dashboard.analysis.modal.addStock.example.Crypto": "e.g. BTC/USDT, ETH/USDT, SOL/USDT",
  "dashboard.analysis.modal.addStock.example.Forex": "e.g. EURUSD, GBPUSD",
  "dashboard.analysis.modal.addStock.example.Futures": "e.g. GC, CL, ES",
  "dashboard.analysis.modal.addStock.example.MOEX": "e.g. SBER, GAZP, LKOH",
  "dashboard.analysis.modal.addStock.switchTo": "Switch to {market}",
  "dashboard.analysis.modal.addStock.mismatch.cn": "\"{symbol}\" looks like a CN A-share code (6 digits), not {market}.",
  "dashboard.analysis.modal.addStock.mismatch.hk": "\"{symbol}\" looks like a Hong Kong stock code (.HK suffix), not {market}.",
  "dashboard.analysis.modal.addStock.mismatch.cryptoPairHint": "Crypto symbols should be entered as BASE/QUOTE, such as BTC/USDT. If you submit \"{symbol}\", it will be auto-completed to {pair}.",
  "dashboard.analysis.modal.addStock.missingMarketOrSymbol": "Missing market or symbol",
  "dashboard.analysis.modal.addStock.validate.cn": "\"{symbol}\" looks like a CN A-share; choose {target} instead of {market}.",
  "dashboard.analysis.modal.addStock.validate.hk": "\"{symbol}\" looks like a Hong Kong stock; choose {target}.",
  ...
  "dashboard.indicator.action.publish": "Publish to Market",
  ...
  "dashboard.indicator.publish.title": "Publish to Market",
  "dashboard.indicator.publish.editTitle": "Manage Publication",
  "dashboard.indicator.publish.hint": "After publishing, other users can view and purchase your indicator in the Market.",
  ...
  "dashboard.indicator.drawing.measureHint": "Select tool or hold Shift and drag on chart to show price change %",
  ...
  "dashboard.indicator.editor.publishToCommunity": "Publish to Market",
  "dashboard.indicator.editor.publishToCommunityHint": "After publishing, other users can view and use your indicator in the Market.",
  ...
  "dashboard.indicator.boundary.indicatorRule": "Indicator scripts are chart-only. Use output.plots, output.signals, and output.layers for visualization; do not place execution, sizing, or risk logic in indicators.",
  ...
  "dashboard.indicator.backtest.title": "Script backtest",
  ...
  "dashboard.indicator.backtest.running": "Running Strategy API V2 backtest...",
  ...
  "dashboard.indicator.backtest.executionAssumptions.modeScriptStandard": "Script standard · bar-by-bar · next-bar open fill",
  "dashboard.indicator.backtest.executionAssumptions.scriptStandardShort": "Script std",
  "dashboard.indicator.backtest.executionAssumptions.timingScriptNextBar": "Bar-by-bar · next-bar open fill",
  "dashboard.indicator.backtest.executionAssumptions.bodyScriptStandard": "Script strategy backtest: handle_data runs on each closed bar at the strategy timeframe; orders from the script are filled at the next bar open by default (plus slippage/fees). This is not the indicator strict/non-strict toggle — it is the standard script replay path.",
  ...
  "dashboard.indicator.backtest.executionAssumptions.tradeCountScriptNote": "Script backtest replays handle_data bar-by-bar; trade count follows script orders plus platform fill rules (default: next-bar open).",
  ...
  "backtest-center.subtitle": "Run Strategy API V2 backtests, inspect history, and review execution results.",
  "backtest-center.tabs.indicator": "Script backtest",
  ...
  "backtest-center.config.signalTimingHelp": "Strategy API V2 execution is driven by the strategy code and selected K-line timeframe.",
  ...
  "dashboard.indicatorStrategies": "Script Strategies",
  ...
  "dashboard.setupGuide.title": "No live strategies or bots running yet",
  "dashboard.setupGuide.desc": "Strategy API V2 deployments and template strategies share this performance overview. Create and start a strategy to aggregate positions, fills, and returns here.",
  "dashboard.setupGuide.path": "Path: Strategy IDE or template executor -> configure account and symbol -> start live execution.",
  ...
  "trading-assistant.scriptLiveNotSupportedHint": "Strategy API V2 deployments run on each completed K-line through handle_data and use the Strategy API V2 order API.",
  ...
  "trading-assistant.form.sectionRiskExecutionParamsDesc": "TP/SL, scaling, and position size",
  "trading-assistant.form.riskFromIndicatorInfo": "Risk, sizing, timeframe, and execution rules now belong in Strategy API V2 code. Indicators are chart-only and cannot drive backtests or live orders.",
  "trading-assistant.form.riskFromIndicatorMissingWarn": "No Strategy API V2 source was detected for this setup. Create or select a Strategy API V2 before live execution.",
  ...
  "trading-assistant.form.advancedModeHint": "Shows more trading and risk-control fields",
  "trading-assistant.form.defaultStrategyName": "Auto",
  "trading-assistant.form.defaultStrategy API V2Name": "Python script",
  ...
  "trading-assistant.form.simpleModePresetValue": "Starts with 15m / Futures / 5x. Configure TP/SL and position sizing in Strategy API V2 code.",
  "trading-assistant.form.simpleModeSectionCore": "Core trading setup",
  "trading-assistant.form.simpleModeSectionCoreDesc": "Finish pair and capital settings first, then decide whether to enable live trading; risk lives in Strategy API V2 code.",
  ...
  "trading-assistant.form.scriptStepParams": "Run setup",
  "trading-assistant.form.scriptStepSignalLive": "Signals & live trading",
  "trading-assistant.form.scriptStepCodeHint": "Write and verify your strategy code first, then configure trading parameters and how it runs.",
  "trading-assistant.form.scriptSource": "Strategy source",
  "trading-assistant.form.scriptSourceTitle": "Choose a strategy source",
  "trading-assistant.form.scriptSourceHint": "Choose a saved strategy source and review its template parameters below. Symbol, capital, live account, and notifications are configured in the next steps.",
  "trading-assistant.form.scriptSourcePlaceholder": "Select a saved strategy",
  "trading-assistant.form.scriptSourceRequired": "Select a strategy source first",
  "trading-assistant.form.scriptSourceCodeMissing": "The selected strategy has no usable code",
  "trading-assistant.form.scriptSourceLoadFailed": "Failed to load strategy source",
  "trading-assistant.form.manageScriptSources": "Manage script sources in Strategy IDE",
  ...
  "trading-assistant.form.scriptRuntimeBoundaryInfo": "Only symbol, spot/swap, direction, investment amount, and leverage are selected here. Script code owns layers, spacing, martingale sizing, take profit, and stop logic. Runtime uses fixed 1m handle_data and 10s price checks.",
  ...
  "trading-assistant.form.longOnlyBrokerHint": "IBKR / Alpaca live execution is currently long-only. To go short: use a perpetual-swap crypto exchange (Binance/OKX/Bybit) for crypto,.",
  ...
  "trading-assistant.form.indicatorStrategy": "Strategy API V2",
  "trading-assistant.form.indicatorStrategyDesc": "Python ctx Strategy API V2 for backtesting and live execution",
  ...
  "trading-assistant.form.localDeploymentHint": "IBKR are external trading interfaces that require local deployment of QuantDinger. Cloud SaaS mode is not supported. Please ensure you have installed and configured the trading software (TWS/IB Gateway or IB Gateway terminal) on your local machine.",
  ...
  "trading-assistant.form.savedCredential": "My account",
  "trading-assistant.form.savedCredentialHint": "Select one of your exchange or broker accounts to auto-fill API settings.",
  ...
  "trading-assistant.messages.indicatorStrategyRemoved": "Indicators are chart-only and cannot run live. Please create a Strategy API V2.",
  "trading-assistant.messages.scriptStrategyOnly": "Executable strategies now use Strategy API V2 only.",
  ...
  "trading-assistant.placeholders.selectSavedCredential": "Select account",
  ...
  "trading-assistant.table.commission": "Fill Fee",
  "trading-assistant.costs.grossRealized": "Realized Price P&L",
  "trading-assistant.costs.openingCommission": "Opening Fees",
  "trading-assistant.costs.closingCommission": "Closing Fees",
  "trading-assistant.costs.regulatoryFees": "Regulatory Fees (REG/TAF/CAT)",
  "trading-assistant.costs.adrFees": "ADR Fees",
  "trading-assistant.costs.marginInterest": "Margin Interest",
  "trading-assistant.costs.otherBrokerFees": "Other Broker Fees",
  "trading-assistant.costs.funding": "Funding (Received/Paid)",
  "trading-assistant.costs.netRealized": "Net Realized P&L",
  "backtest-center.fundingNotModeled": "Not modeled (fees and slippage only)",
  "trading-assistant.table.gridMatchedProfit": "Grid profit",
  ...
  "trading-assistant.table.noTrades": "No trade records",
  "trading-assistant.positions.strategyLedger": "Strategy ledger",
  "trading-assistant.positions.accountMirror": "Account mirror (exchange truth)",
  ...
  "trading-assistant.positions.accountPositionsTitle": "Account positions",
  "trading-assistant.positions.tabSwap": "Futures",
  "trading-assistant.positions.tabSpot": "Spot",
  "trading-assistant.positions.tabOpenOrders": "Open orders",
  "trading-assistant.positions.noSwapPositions": "No futures positions",
  "trading-assistant.positions.noSpotPositions": "Spot account connected; no non-zero wallet balance",
  "trading-assistant.positions.noOpenOrders": "No open orders",
  "trading-assistant.positions.liveFetchedAt": "Fetched at",
  "trading-assistant.positions.orderType": "Type",
  "trading-assistant.positions.filled": "Filled",
  "trading-assistant.positions.orderStatus": "Status",
  "trading-assistant.positions.snapshotFailed": "Failed to load account data",
  "trading-assistant.positions.snapshotFetchErrors": "Could not fetch account data from the exchange",
  "trading-assistant.positions.snapshotPartial": "Some requests failed; showing partial results below",
  "trading-assistant.positions.fetchFailedShort": "Fetch failed — see error above",
  "trading-assistant.positions.note.strategy_only": "Strategy-only snapshot",
  "trading-assistant.positions.note.account_only": "Account-only leg",
  "trading-assistant.positions.note.size_mismatch": "Size mismatch",
  "trading-assistant.positions.reconciliation.ok.title": "Reconciliation OK",
  "trading-assistant.positions.reconciliation.ok.desc": "Strategy ledger matches the exchange account mirror.",
  "trading-assistant.positions.reconciliation.strategy_only.title": "Strategy snapshot out of sync",
  "trading-assistant.positions.reconciliation.strategy_only.desc": "Local strategy rows still show size while the exchange leg is flat. Sync will remove ghosts on the next cycle.",
  "trading-assistant.positions.reconciliation.account_only.title": "Other account positions",
  "trading-assistant.positions.reconciliation.account_only.desc": "The exchange account still has legs that are not attributed to this strategy (Quick Trade, manual orders, or another strategy).",
  "trading-assistant.positions.reconciliation.mismatch.title": "Position size mismatch",
  "trading-assistant.positions.reconciliation.mismatch.desc": "Strategy ledger size differs from the account mirror. Check fills and whether the API key is shared.",
  "trading-assistant.tradeReason.grid_reduce_long": "Grid reduce long",
  "trading-assistant.tradeReason.long_entry": "Grid buy long",
  "trading-assistant.tradeReason.long_exit": "Grid sell close long",
  "trading-assistant.tradeReason.short_entry": "Grid sell short",
  "trading-assistant.tradeReason.short_exit": "Grid buy cover short",
  "trading-assistant.tradeReason.grid_initial_long": "Initial long position",
  "trading-assistant.tradeReason.grid_initial_short": "Initial short position",
  "trading-assistant.tradeReason.grid_reduce_short": "Grid reduce short",
  "trading-assistant.tradeReason.grid_close_all": "Grid close all",
  "trading-assistant.tradeReason.grid_waterfall_close": "Waterfall protection close",
  "trading-assistant.tradeReason.grid_equity_stop_loss": "Grid equity stop-loss",
  "trading-assistant.tradeReason.grid_equity_take_profit": "Grid equity take-profit",
  "trading-assistant.tradeReason.grid_out_of_bounds_up": "Grid upper-bound breakout",
  "trading-assistant.tradeReason.grid_out_of_bounds_down": "Grid lower-bound breakdown",
  "trading-assistant.tradeReason.server_stop_loss": "Stop-loss close",
  "trading-assistant.tradeReason.server_take_profit": "Take-profit close",
  "trading-assistant.tradeReason.server_trailing_stop": "Trailing stop close",
  "trading-assistant.tradeReason.indicator_signal": "Signal close",
  "trading-assistant.tradeReason.signal_trigger": "Signal close",
  ...
  "trading-assistant.strategyTypeOptions.indicator": "Strategy API V2",
  ...
  "settings.sensitiveAutofillBlocked": "Some sensitive settings look like browser autofill values: {fields}. Clear them or enter the real keys before saving.",
  "settings.loadFailed": "Failed to load settings",
  "request.forbiddenTitle": "Operation not allowed",
  ...
  "request.backtestRangeLimitWarmup": " including {warmupBars} warmup bars",
  ...
  "settings.secretConfiguredPlaceholder": "Saved. Leave blank to keep the current secret",
  ...
  "settings.link.viewDocs": "View Docs",
  ...
  "settings.option.LLM_PROVIDER.litellm": "LiteLLM (100+ providers)",
  "settings.llm.currentProviderTitle": "Current provider: {provider}",
  "settings.llm.currentProviderDesc": "Switching providers keeps the other provider settings saved; switch back anytime to edit them.",
  "settings.llm.providerSection": "Model provider",
  "settings.llm.providerSectionDesc": "Choose the LLM provider used by analysis, code generation, and strategy review.",
  "settings.llm.activeProviderSection": "Provider credentials",
  "settings.llm.activeProviderSectionDesc": "Fill only the key, model, and Base URL for the selected provider.",
  "settings.llm.customProfilesTitle": "Custom API profiles",
  "settings.llm.customProfilesDesc": "Save multiple OpenAI-compatible endpoints (e.g. Zhipu, Volcengine Ark) and switch without overwriting.",
  "settings.llm.customProfilesBadge": "Profiles",
  "settings.llm.customProfilesSelect": "Select a profile",
  "settings.llm.customProfilesAdd": "Add",
  "settings.llm.customProfilesRename": "Rename",
  "settings.llm.customProfilesDelete": "Delete",
  "settings.llm.customProfilesNamePrompt": "Profile name",
  "settings.llm.customProfilesNewName": "New profile",
  "settings.llm.customProfilesDeleteConfirm": "Delete this profile?",
  "settings.llm.commonSection": "Common AI parameters",
  "settings.llm.commonSectionDesc": "These options apply across all providers.",
  "settings.llm.searchSection": "News and web search",
  "settings.llm.searchSectionDesc": "Optional keys used to enrich AI analysis with market news and web data.",
  "settings.advanced.title": "More settings",
  "settings.advanced.description": "Optional integrations, endpoints, and tuning controls remain available here.",
  "settings.market.status.ready": "Ready",
  "settings.market.status.partial": "Needs setup",
  "settings.market.status.blocked": "Blocked",
  "settings.market.status.disabled": "Disabled",
  "settings.market.source.builtin": "built-in",
  "settings.market.source.configured": "configured",
  "settings.market.source.required": "required",
  "settings.market.source.recommended": "recommended",
  "settings.market.source.optional": "optional",
  "settings.market.livePrefix": "Live",
  "settings.market.researchOnly": "Research / paper only",
  "settings.market.desc.Crypto": "Digital assets and crypto derivatives.",
  "settings.market.desc.USStock": "US equities and ETFs.",
  "settings.market.desc.CNStock": "Mainland China A-share equities.",
  "settings.market.desc.HKStock": "Hong Kong equities and ETFs.",
  "settings.market.desc.Forex": "FX pairs and precious metals routed through FX data sources and IB Gateway.",
  "settings.market.desc.Futures": "Generic futures research market. Live execution is not enabled yet.",
  "settings.market.desc.MOEX": "Moscow Exchange research market. Live execution is not enabled yet.",
  "settings.market.sourceLabel.ccxt": "CCXT exchange",
  ...
  "settings.market.sourceLabel.tushare": "Tushare",
  ...
  "settings.option.SEARCH_PROVIDER.gdelt": "GDELT News",
  ...
  "settings.group.market_modules": "Market Modules",
  ...
  "settings.field.MFA_ENABLED": "Enable Authenticator App MFA",
  "settings.field.MFA_RISK_LOGIN_ONLY": "MFA Only for Risky Login",
  ...
  "settings.field.MFA_CHALLENGE_EXPIRE_MINUTES": "MFA Challenge Expiry (min)",
  "settings.field.MFA_MAX_ATTEMPTS": "MFA Max Attempts",
  ...
  "settings.field.ALLOW_LOCAL_DESKTOP_BROKERS": "Allow IBKR (local desktop brokers)",
  "settings.field.ENABLED_MARKETS": "Supported Markets",
  ...
  "settings.field.FINNHUB_FREE_ONLY": "Finnhub Free-only Mode",
  ...
  "settings.field.TRADING_ECONOMICS_BASE_URL": "Trading Economics Base URL",
  "settings.field.TRADING_ECONOMICS_TIMEOUT": "Trading Economics Timeout (sec)",
  "settings.field.FRED_API_KEY": "FRED API Key",
  "settings.field.FRED_BASE_URL": "FRED Base URL",
  "settings.field.FRED_TIMEOUT": "FRED Timeout (sec)",
  "settings.field.BLS_API_KEY": "BLS API Key",
  "settings.field.BLS_BASE_URL": "BLS Base URL",
  "settings.field.BLS_TIMEOUT": "BLS Timeout (sec)",
  "settings.field.BEA_API_KEY": "BEA API Key",
  "settings.field.BEA_BASE_URL": "BEA Base URL",
  "settings.field.BEA_TIMEOUT": "BEA Timeout (sec)",
  "settings.field.COINGLASS_API_KEY": "Coinglass API Key",
  "settings.field.CRYPTOQUANT_API_KEY": "CryptoQuant API Key",
  "settings.field.TUSHARE_TOKEN": "Tushare Token",
  "settings.field.TUSHARE_HTTP_URL": "Tushare HTTP API URL",
  ...
  "settings.field.ADANOS_API_BASE_URL": "Adanos API Base URL",
  ...
  "settings.field.GDELT_BASE_URL": "GDELT Base URL",
  "settings.field.GDELT_TIMEOUT": "GDELT Timeout (sec)",
  "settings.field.GDELT_MAX_RESULTS": "GDELT Max Results",
  "settings.field.ALPHA_VANTAGE_API_KEY": "Alpha Vantage API Key",
  "settings.field.ALPHA_VANTAGE_BASE_URL": "Alpha Vantage Base URL",
  "settings.field.ALPHA_VANTAGE_TIMEOUT": "Alpha Vantage Timeout (sec)",
  ...
  "settings.desc.OPENAI_MODEL": "OpenAI direct model name without provider prefix, e.g. gpt-5.4 or gpt-4o-mini.",
  ...
  "settings.desc.ATLASCLOUD_API_KEY": "AtlasCloud API key",
  ...
  "settings.desc.GDELT_BASE_URL": "GDELT DOC 2.0 free global news and event search endpoint.",
  "settings.desc.GDELT_TIMEOUT": "Timeout for GDELT requests.",
  "settings.desc.GDELT_MAX_RESULTS": "Maximum news/event results returned by GDELT per request.",
  "settings.desc.ALPHA_VANTAGE_API_KEY": "Alpha Vantage API key for company news and NEWS_SENTIMENT enrichment.",
  "settings.desc.ALPHA_VANTAGE_BASE_URL": "Alpha Vantage API endpoint. Usually no need to change.",
  "settings.desc.ALPHA_VANTAGE_TIMEOUT": "Timeout for Alpha Vantage requests.",
  "settings.desc.ALPHA_VANTAGE_NEWS_LIMIT": "Maximum items returned by the Alpha Vantage news sentiment endpoint.",
  ...
  "settings.desc.ALLOW_LOCAL_DESKTOP_BROKERS": "Allow local desktop broker integrations such as IBKR. Disable this for cloud-only deployments.",
  "settings.desc.ENABLED_MARKETS": "Choose which market modules are visible and usable in watchlists, market data, Strategy R&D, AI analysis, and Agent API. Empty falls back to legacy SHOW_* flags.",
  ...
  "menu.aiSkills": "AI Skills",
  "aiSkills.heroEyebrow": "Agent capability registry",
  "aiSkills.title": "AI Skill Center",
  "aiSkills.subtitle": "Manage prompt skills, inspect system tools, and keep every AI workflow aligned with QuantDinger boundaries.",
  "aiSkills.refresh": "Refresh",
  "aiSkills.install": "Install skill",
  "aiSkills.skills": "Skills",
  "aiSkills.tools": "Tools",
  "aiSkills.allCategories": "All categories",
  "aiSkills.searchSkills": "Search skills...",
  "aiSkills.showDisabled": "Show disabled",
  "aiSkills.builtin": "Built-in",
  "aiSkills.installed": "Installed",
  "aiSkills.detail": "Detail",
  "aiSkills.delete": "Delete",
  "aiSkills.deleteConfirm": "Delete this installed skill?",
  "aiSkills.readOnly": "Read-only",
  "aiSkills.writeTool": "Write workflow",
  "aiSkills.installTitle": "Install prompt skill manifest",
  "aiSkills.installHint": "Paste a JSON manifest. This version only allows prompt skills, not executable code.",
  "aiSkills.example": "Use example",
  "aiSkills.safetyTitle": "Safety boundary",
  "aiSkills.rulePromptOnly": "Only prompt skills can be installed.",
  "aiSkills.ruleNoCode": "Executable fields such as shell, Python, webhook, and commands are rejected.",
  "aiSkills.ruleBoundary": "Strategy deployments are created stopped by default.",
  "aiSkills.ruleUserControl": "Live quick orders require explicit confirmation and all server-side safety gates.",
  "aiSkills.category": "Category",
  "aiSkills.source": "Source",
  "aiSkills.risk": "Risk",
  "aiSkills.requires": "Requires",
  "aiSkills.produces": "Produces",
  "aiSkills.promptTemplate": "Prompt template",
  "aiSkills.enabled": "Enabled",
  "aiSkills.availableToAgent": "Available to Agent",
  "aiSkills.userExtensions": "User extensions",
  "aiSkills.skill": "Skill",
  "aiSkills.actions": "Actions",
  "aiSkills.id": "ID",
  "aiSkills.updated": "Skill updated",
  "aiSkills.updateFailed": "Update failed",
  "aiSkills.deleted": "Skill deleted",
  "aiSkills.deleteFailed": "Delete failed",
  "aiSkills.invalidJson": "Invalid JSON",
  "aiSkills.installedSuccess": "Skill installed",
  "aiSkills.installFailed": "Install failed",
  ...
  "agentTokens.marketsHint": "Comma-separated; * = all markets. Examples: Crypto or Crypto,USStock,Forex",
  "agentTokens.instruments": "Instruments",
  "agentTokens.instrumentsHint": "Comma-separated; * = all symbols. Examples: BTC/USDT,ETH/USDT or AAPL,TSLA (limits T-scope trading when set)",
  ...
  "userManage.searchPlaceholder": "Search username/email/nickname/ID",
  "userManage.searchById": "User ID",
  ...
  "profile.creditsLog.actionMembershipPurchase": "Membership Purchase",
  "profile.creditsLog.actionMembershipBonus": "Membership Bonus",
  "profile.creditsLog.actionMembershipMonthly": "Monthly Credits",
  ...
  "userManage.batchBan": "Batch ban",
  "userManage.clearSelection": "Clear selection",
  "userManage.selectedCount": "{count} selected",
  "userManage.batchBanConfirm": "Ban {count} selected users? They will not be able to log in after being banned.",
  "userManage.batchBanSuccess": "Banned {count} users",
  "userManage.batchBanPartial": "Banned {success} users, {failed} failed",
  "userManage.batchBanFailed": "Batch ban failed",
  "userManage.batchBanNoValid": "Please select users that can be banned",
  "systemOverview.tabTitle": "System Overview",
  "systemOverview.contractTitle": "Strategy API V2 Runtime Overview",
  "systemOverview.contractDesc": "CTA, portfolio, and robot deployments share one source contract. Signal-only simulation capital is excluded from live-account totals.",
  "systemOverview.contractReady": "Contract ready",
  "systemOverview.legacyRecords": "Legacy records",
  "systemOverview.cta": "CTA",
  "systemOverview.portfolio": "Portfolio",
  "systemOverview.robot": "Robot",
  "systemOverview.v2Deployments": "V2 deployments",
  "systemOverview.signalCapitalExcluded": "signal-only capital excluded",
  "systemOverview.liveCapital": "Live capital",
  "systemOverview.livePnlDesc": "Live positions and fills only",
  "systemOverview.livePnl": "Live PnL",
  "systemOverview.filterClassAll": "All strategy types",
  "systemOverview.colStrategyClass": "Type",
  "systemOverview.colSource": "Strategy / source",
  "systemOverview.contractV2": "Contract ready",
  "systemOverview.contractIncomplete": "Contract incomplete",
  "systemOverview.sourceId": "Source",
  "systemOverview.colUniverse": "Market / universe",
  "systemOverview.notApplicable": "Not applicable",
  "systemOverview.signalOnlyNoPnl": "Signal only; no capital PnL",
  "systemOverview.colRuntime": "Runtime ledger",
  "systemOverview.positionsShort": "Positions",
  "systemOverview.tradesShort": "Fills",
  "systemOverview.colActivity": "Last activity",
  "systemOverview.schedules": "Schedules",
  "systemOverview.eventDriven": "Event driven",
  ...
  "systemOverview.searchPlaceholder": "Search strategy/symbol/user/ID",
  "systemOverview.searchStrategyId": "Strategy ID",
  "systemOverview.searchUserId": "User ID",
  "systemOverview.colUserId": "User ID",
  "systemOverview.startStrategy": "Start strategy",
  "systemOverview.stopStrategy": "Stop strategy",
  "systemOverview.switchOn": "On",
  "systemOverview.switchOff": "Off",
  "systemOverview.viewUserStrategies": "View user strategies",
  "systemOverview.confirmStopLiveTitle": "Stop live strategy?",
  "systemOverview.confirmStopLiveDesc": "This stops the live executor for this user strategy. Confirm before proceeding.",
  ...
  "systemOverview.invalidUserId": "Invalid user ID",
  "systemOverview.filteredByUser": "Showing strategies for user {id}",
  "systemOverview.applyFilters": "Search",
  "systemOverview.clearFilters": "Clear filters",
  "systemOverview.activeFilters": "Active filters",
  "systemOverview.filterKeyword": "Keyword",
  ...
  "liveMonitor.health": "Runtime health",
  "liveMonitor.attention": "Needs attention",
  "liveMonitor.pendingOrders": "Pending orders",
  "liveMonitor.exposure": "Gross exposure",
  "liveMonitor.heartbeat": "Last heartbeat",
  "liveMonitor.openPositions": "positions",
  "liveMonitor.failedOrders": "failed",
  "liveMonitor.healthy": "Healthy",
  "liveMonitor.degraded": "Degraded",
  "liveMonitor.stale": "Stale",
  "liveMonitor.offline": "Offline",
  "liveMonitor.inactive": "Inactive",
  "liveMonitor.unknown": "Unknown",
  "liveMonitor.performanceAnalysis": "Performance analysis",
  "systemOverview.realized": "Real",
  "systemOverview.unrealized": "Unreal",
  "systemOverview.symbols": "symbols",
  "systemOverview.strategyStartNotPersisted": "The strategy did not stay running. Open the strategy to inspect the runtime logs.",
  ...
  "settings.field.BILLING_COST_AI_INDICATOR_TO_STRATEGY": "AI Indicator-to-Strategy Cost",
  "settings.field.BILLING_COST_AI_TUNING": "AI Parameter Tuning Cost",
  "settings.field.BILLING_COST_AI_COPILOT_CHAT": "AI Copilot Chat Cost",
  "settings.field.BILLING_COST_AI_COPILOT_IMAGE": "AI Copilot Image Analysis Cost",
  "settings.field.BILLING_COST_AI_COPILOT_RADAR": "AI Copilot Opportunity Radar Cost",
  "settings.field.MARKETPLACE_PLATFORM_FEE_RATE": "Marketplace Platform Fee Rate",
  ...
  "settings.field.USDT_PAY_ENABLED_CHAINS": "Enabled Chains",
  "settings.field.USDT_TRC20_ADDRESS": "TRC20 Receiving Address",
  "settings.field.USDT_BEP20_ADDRESS": "BEP20 Receiving Address",
  "settings.field.USDT_ERC20_ADDRESS": "ERC20 Receiving Address",
  "settings.field.USDT_SOL_ADDRESS": "Solana Receiving Address",
  ...
  "settings.field.USDT_WORKER_POLL_INTERVAL": "Worker Poll Interval (sec)",
  ...
  "settings.desc.BILLING_COST_AI_INDICATOR_TO_STRATEGY": "Credits consumed each time AI converts a chart-only indicator into an executable Strategy API V2.",
  "settings.desc.BILLING_COST_AI_TUNING": "Credits consumed per AI parameter tuning run (multi-round model calls plus backtests)",
  "settings.desc.BILLING_COST_AI_COPILOT_CHAT": "Credits consumed per AI Copilot natural-language turn",
  "settings.desc.BILLING_COST_AI_COPILOT_IMAGE": "Extra credits consumed when a Copilot message includes chart screenshots or images",
  "settings.desc.BILLING_COST_AI_COPILOT_RADAR": "Credits consumed per AI Copilot opportunity radar / market scan request",
  "settings.desc.MARKETPLACE_PLATFORM_FEE_RATE": "Platform commission deducted from paid marketplace purchases before crediting the seller. Use 0.1 for 10%, or 10%.",
  ...
  "settings.desc.MFA_ENABLED": "Allow users to opt in to authenticator-app two-step verification from their profile. This does not force every user to bind MFA.",
  "settings.desc.MFA_RISK_LOGIN_ONLY": "When enabled, MFA-enabled users are challenged only on new-device or new-location password logins. Disable it to challenge every password login.",
  "settings.desc.MFA_CHALLENGE_EXPIRE_MINUTES": "How long the post-password MFA challenge remains valid.",
  "settings.desc.MFA_MAX_ATTEMPTS": "Maximum wrong authenticator-code attempts before the user must start login again.",
  ...
  "globalMarket.usStockHeatmap": "US Stocks",
  "globalMarket.hkStockHeatmap": "HK Stocks",
  ...
  "globalMarket.calendarUnavailable": "Calendar unavailable",
  "globalMarket.calendarMissingFinnhub": "Free economic calendar sources are currently unavailable. Finnhub paid calendar is skipped by default.",
  "globalMarket.calendarForbidden": "Calendar source access denied",
  "globalMarket.calendarFinnhubForbidden": "The current source cannot access the economic calendar endpoint. QuantDinger prefers Trading Economics free access and AkShare fallback.",
  "globalMarket.calendarLoadFailed": "Calendar failed to load",
  "globalMarket.configureDataSource": "Configure data source",
  ...
  "community.title": "Market",
  "community.marketRiskTip": "Risk notice: indicators, strategies, and backtest data in the market are based on historical data and community sharing for learning and research only. They do not constitute investment advice. Use live trading with caution; profitability is not guaranteed.",
  "community.authorTab": "My Published",
  "community.searchPlaceholder": "Search indicators...",
  "community.all": "All",
  "community.freeOnly": "Free",
  "community.codeVisibilityAll": "Code Visibility",
  "community.minPrice": "Min",
  "community.maxPrice": "Max",
  "community.applyFilters": "Search",
  "community.resetFilters": "Reset",
  "community.chartIndicator": "Chart Indicator",
  "community.visualProfile": "Visual Profile",
  "community.adjustableParams": "Adjustable params",
  "community.paramCount": "{n} params",
  "community.chartMarkers": "Chart markers",
  "community.overlayLayers": "Overlay layers",
  "community.indicatorProfile": "Indicator Profile",
  "community.chartOnlyIndicator": "Indicators are chart-only",
  "community.chartOnlyIndicatorHint": "Use indicators to inspect trends, signals, and zones. Convert to a strategy before backtesting or live trading.",
  "community.parameters": "Parameters",
  "community.visualSignals": "Visual signals",
  "community.chartAnnotations": "Chart annotations",
  "community.noRatings": "No ratings",
  ...
  "community.overfitRisk.high": "High",
  "community.overfitRisk.tickLow": "Stable",
  "community.overfitRisk.tickMid": "Watch",
  "community.overfitRisk.tickHigh": "Caution",
  "community.overfitRisk.level.low": "Low",
  "community.overfitRisk.level.medium": "Moderate",
  "community.overfitRisk.level.high": "Elevated",
  "community.overfitRisk.level.extreme": "Extreme",
  "community.overfitRisk.hintMedium": "Strong strategy stats — validate across more symbols and samples.",
  "community.overfitRisk.hintHigh": "Strategy returns look unusually high; overfitting is possible.",
  "community.overfitRisk.hintExtreme": "Extremely high strategy returns — likely overfit. Verify on multiple symbols before live use.",
  "community.overfitRisk.tooltip": "Heuristic risk score ({score}/100) from strategy KPIs, {n} sample(s). Not a guarantee of future performance.",
  ...
  "community.performance": "Backtest Performance",
  "community.backtestDurationDays": "{days}d",
  ...
  "community.insufficientCreditsDetail": "Insufficient credits: this purchase needs {required} credits, you have {current}, short by {shortage}.",
  ...
  "community.yourPurchasePrice": "Your purchase price",
  "community.currentPrice": "Current price",
  "community.codeVisibility": "Code visibility",
  "community.indicatorSourceCode": "Indicator source",
  "community.scriptSourceCode": "Script source",
  "community.codeVisible": "Source visible",
  "community.codeHidden": "Source hidden",
  "community.codeVisibleHint": "After purchase, you can view and edit the source code in your local workspace.",
  "community.codeHiddenHint": "After purchase, you can use the asset, but the publisher has not opened the source code.",
  ...
  "community.restoreCopy": "Restore Copy",
  "community.restoringCopy": "Restoring...",
  "community.restoreCopyTooltip": "Your local copy was deleted. Restore it from your purchased asset.",
  "community.restoreCopyConfirmTitle": "Restore local copy?",
  "community.restoreCopyConfirmContent": "A new local copy will be generated from the currently available marketplace version. You do not need to purchase it again.",
  "community.restoreCopySuccess": "Local copy restored",
  "community.restoreCopyFailed": "Failed to restore copy",
  "community.local_copy_not_found": "Could not find your local copy. It may have been deleted; restore it from your purchase.",
  "community.indicator_unpublished": "This indicator has been unpublished",
  "community.listing_deleted_no_update": "This asset is no longer in the market. Your purchased copy remains available.",
  "community.listing_unpublished_no_update": "This asset has been unpublished. Your purchased copy remains available, but no newer public version can be synced.",
  ...
  "community.admin.searchPlaceholder": "Search name, description, or author...",
  "community.admin.allTypes": "All types",
  "community.admin.sortOldest": "Oldest",
  ...
  "community.admin.reviewedAt": "Reviewed",
  "community.admin.copyCode": "Copy Code",
  "community.admin.codeCopied": "Code copied",
  "community.admin.codeCopyFailed": "Copy failed",
  "community.admin.codeMeta": "{lines} lines / {chars} chars",
  "community.admin.backtestData": "Backtest Data",
  "community.admin.backtestSamples": "Backtest Samples",
  "community.admin.bestRun": "Best Run",
  "community.admin.noBacktestData": "No backtest data available for review yet",
  "community.admin.backtestLoadFailed": "Failed to load backtest data",
  ...
  "trading-assistant.pageBanner.signal.badge": "Strategy API V2",
  "trading-assistant.pageBanner.signal.desc": "Indicators are chart-only source material; use Strategy API V2 for live execution",
  "trading-assistant.pageBanner.script.badge": "Strategy API V2 · Strategy API V2",
  "trading-assistant.pageBanner.script.desc": "Python bar-by-bar execution for state machines, scale-in, and complex position control",
  "trading-assistant.strategyMode.signal": "Chart Indicator",
  "trading-assistant.strategyMode.script": "Python Strategy API V2",
  "trading-assistant.strategyMode.signalBadge": "Chart-only",
  "trading-assistant.strategyMode.scriptBadge": "Best for complex logic",
  "trading-assistant.strategyMode.signalDesc": "Indicators only render chart overlays and labels. Convert visible logic to a Python Strategy API V2 before backtesting or live trading.",
  ...
  "trading-assistant.strategyMode.signalFeature1": "Chart overlays, labels, and visual signals only",
  "trading-assistant.strategyMode.signalFeature2": "No live orders or backtest execution from indicators",
  "trading-assistant.strategyMode.signalFeature3": "Use Strategy API V2 for risk, sizing, and execution",
  ...
  "trading-assistant.selectModeHint": "Create executable Python Strategy API V2 code, or start from a database template.",
  ...
  "trading-assistant.editor.title": "Script Code",
  ...
  "trading-assistant.editor.aiGenerate": "AI Generate Script",
  "trading-assistant.editor.aiGenerateBtn": "Generate",
  "trading-assistant.editor.aiPromptPlaceholder": "Describe the script logic, e.g.: Write a Donchian breakout pyramid script with a 20-bar exit channel and 4 investment layers...",
  ...
  "trading-assistant.editor.codeParamsTitle": "Code Parameters",
  "trading-assistant.editor.codeParamsDesc": "Detected from the Strategy API V2 parameter contract. Adjust values here and apply them back to the strategy source.",
  "trading-assistant.editor.hiddenCodeTitle": "Author hid the source code",
  "trading-assistant.editor.hiddenCodeDesc": "The script source is not visible, but you can still adjust parameters and use it for backtests or live strategies.",
  "trading-assistant.editor.hiddenParamsTitle": "Adjustable Parameters",
  "trading-assistant.editor.hiddenParamsDesc": "The author hid the source code. Parameters are saved in the script configuration and used by backtests and live runs.",
  "trading-assistant.editor.hiddenParamsLive": "Parameters apply immediately",
  "trading-assistant.editor.codeHint": "Write strategy code using the ctx object for trading API",
  "trading-assistant.editor.generating": "Generating script code...",
  "trading-assistant.editor.templateIntroTitle": "Get started with a script",
  "trading-assistant.editor.templateIntroDesc": "Start from a blank Strategy API V2 source or a system strategy template. Instruments, markets, frequency, and scheduling are controlled by the source.",
  "trading-assistant.editor.blankTemplate": "Blank script",
  "trading-assistant.editor.blankTemplateDesc": "Minimal initialize / handle_data skeleton — write your own logic",
  "trading-assistant.editor.statefulTemplateBadge": "Template",
  "trading-assistant.editor.statefulTemplateSection": "Script templates",
  "trading-assistant.editor.templateEmpty": "No script templates are available. Check the database template configuration.",
  "trading-assistant.editor.resetTemplateParams": "Reset Defaults",
  "trading-assistant.editor.applyTemplateParams": "Apply to Code",
  "trading-assistant.editor.paramsEmpty": "This script has no adjustable parameters",
  "trading-assistant.editor.templateApplied": "Template parameters applied to code",
  "trading-assistant.editor.aiHint": "Pick a template first, then adjust strategy parameters. Strategy source owns symbol, market type, frequency, direction, sizing and risk; the run panel owns capital, date range and permitted Crypto swap leverage.",
  "trading-assistant.editor.docsIntroTitle": "Built-in API Reference",
  "trading-assistant.editor.docsIntroDesc": "These are the commonly used QuantDinger Strategy API V2 APIs and lifecycle hooks, so you can code and look up usage side by side.",
  "trading-assistant.editor.aiPromptRequired": "Please describe what you want AI to generate or revise first",
  "trading-assistant.editor.aiGenerateSuccess": "AI generated script code",
  ...
  "trading-assistant.editor.aiSuggestionImprovePrompt": "Improve the current Strategy API V2 structure and logs. Keep instrument, market type, frequency, direction and sizing source-controlled. Do not read context.params in initialize(context).",
  "trading-assistant.editor.aiSuggestionRisk": "Add better risk control",
  "trading-assistant.editor.aiSuggestionRiskPrompt": "Add complete take-profit, stop-loss, bounded layer limits, and cooldown protection with Strategy API V2 order helpers and explicit target sizing.",
  ...
  "trading-assistant.editor.aiPromptTemplateHint": "Continue optimizing this template while preserving source-owned instrument, frequency, direction, sizing and risk rules:",
  "trading-assistant.editor.paramType.number": "Number",
  "trading-assistant.editor.paramType.integer": "Integer",
  "trading-assistant.editor.paramType.percent": "Ratio",
  ...
  "strategyV2.params.kdjSmoothKDesc": "Smoothing period applied to the stochastic K line.",
  "strategyV2.params.kdjSmoothD": "D smoothing",
  "strategyV2.params.kdjSmoothDDesc": "Smoothing period applied to the stochastic D line.",
  ...
  "trading-assistant.templateParam.position_pct.desc": "Percent of account equity per entry; enter 80 for 80%.",
  ...
  "trading-assistant.templateParam.take_profit_price_pct.label": "Take-profit price move",
  "trading-assistant.templateParam.take_profit_price_pct.desc": "Favorable price move from average entry. 0.006 means +0.6% price move.",
  ...
  "trading-assistant.templateParam.max_orders.label": "Max order count",
  "trading-assistant.templateParam.max_orders.desc": "Maximum orders in one sequence, including the first order and all martingale adds.",
  "trading-assistant.templateParam.total_budget_usdt.label": "Total budget",
  "trading-assistant.templateParam.total_budget_usdt.desc": "Maximum amount this martingale sequence may use. Enter 0 to calculate it from the investment ratio.",
  "trading-assistant.templateParam.total_budget_pct.label": "Total budget ratio",
  "trading-assistant.templateParam.total_budget_pct.desc": "Share of the panel investment amount available to this martingale sequence. Use the raw code value: 1 means all investment.",
  "trading-assistant.templateParam.initial_order_usdt.label": "First order amount",
  "trading-assistant.templateParam.initial_order_usdt.desc": "Amount for the first entry. Enter 0 to calculate it from the first-order percent.",
  "trading-assistant.templateParam.first_order_pct.label": "First order ratio",
  "trading-assistant.templateParam.first_order_pct.desc": "First order as a share of the total martingale budget. Adds grow from this amount by the multiplier.",
  ...
  "trading-assistant.performance.gridTotalProfit": "Realised Grid Profit",
  "trading-assistant.performance.gridMatchedPairs": "Matched Grid Pairs",
  "trading-assistant.performance.gridAvgProfit": "Avg Profit / Pair",
  ...
  "dashboard.indicator.action.createStrategy": "AI Indicator to Strategy",
  ...
  "dashboard.indicator.publish.hideCode": "Hide source code",
  "dashboard.indicator.publish.hideCodeHint": "When enabled, buyers cannot view source code in the editor. The system can still run the chart indicator; backtests and live trading require converting it to a Strategy API V2 first.",
  "quickTrade.title": "Quick Trade",
  "quickTrade.selectSymbol": "Select Symbol",
  "quickTrade.exchange": "Trading Account",
  "quickTrade.selectExchange": "Select exchange account",
  "quickTrade.testnetTag": "Testnet",
  "quickTrade.cryptoOnly": "Crypto / US Stocks",
  "quickTrade.noExchange": "No crypto exchange accounts yet. Add one in Broker Accounts.",
  "quickTrade.brokerAccount": "Broker Account",
  "quickTrade.selectBrokerAccount": "Select broker account",
  "quickTrade.noBrokerAccount": "No connected Alpaca account yet. Connect one from Accounts first.",
  "quickTrade.cryptoAccountHint": "Crypto supports spot and USDT perpetuals",
  "quickTrade.usStockSpotOnly": "US stocks trade through Alpaca spot only, without leverage or shorting",
  "quickTrade.syncedWithChart": "Synced with chart",
  "quickTrade.syncedPrice": "Current price",
  "quickTrade.buyingPower": "Buying power",
  "quickTrade.alpacaAccount": "Alpaca US Stock Account",
  "quickTrade.stockSpotModeHint": "US stocks use Alpaca spot buy/sell only. Buy converts amount to shares; sell reduces existing holdings without margin or short selling.",
  "quickTrade.unsupportedMarket": "Quick Trade is not supported for the current market.",
  "quickTrade.addAccountInline": "Add account",
  ...
  "quickTrade.buySpot": "Buy",
  "quickTrade.spotBuyOnlyHint": "Spot supports buy/sell; shorting is not available.",
  ...
  "quickTrade.shortDisabledSpot": "Spot does not support shorting; sell means reducing current holdings.",
  ...
  "quickTrade.positionValue": "Position value",
  ...
  "quickTrade.errorHints.okxAccountMode": "The OKX account is in Spot mode. In OKX Demo Trading, open Settings > Account mode and switch to Futures mode or Multi-currency margin mode, then retry.",
  ...
  "quickTrade.errorHints.regionRestricted": "This exchange is unavailable from the backend server's current region or IP address.",
  ...
  "indicatorIde.aiAssistHint": "Describe your indicator idea in natural language. AI will generate chart-only indicator code: plots, markers, lamp rows, layers, and tunable parameters.",
  "indicatorIde.aiPromptPlaceholder": "Describe the indicator logic, visuals, signal markers, and parameters, e.g. EMA trend, six-signal lamp belt, ChanLun strokes and centers...",
  ...
  "indicatorIde.oosFailed": "OOS validation failed: {error}",
  ...
  "indicatorIde.oosBannerSimple": "Validated by time split: training {trainStart} → {trainEnd}, holdout {oosStart} → {oosEnd}. Check the holdout result before applying parameters.",
  ...
  "indicatorIde.saveShortcutHint": "Save (Ctrl+S)",
  "indicatorIde.noChangesToSave": "No changes to save",
  "indicatorIde.saveAsNew": "Save as new indicator",
  "indicatorIde.codeVersionHistory": "Version history",
  "indicatorIde.codeVersionEmpty": "No code versions yet. Save once to create the first version.",
  "indicatorIde.codeVersionNo": "Version {version}",
  "indicatorIde.codeVersionPreview": "View",
  "indicatorIde.codeVersionPreviewTitle": "Version {version} code",
  "indicatorIde.codeVersionRestore": "Restore",
  "indicatorIde.codeVersionRestoreTitle": "Restore code version",
  "indicatorIde.codeVersionRestoreContent": "Restore version {version}? Current code will be overwritten and saved as a new history version.",
  "indicatorIde.codeVersionRestored": "Restored to the selected version",
  "indicatorIde.codeVersionRestoreFailed": "Failed to restore version",
  "indicatorIde.codeVersionLoadFailed": "Failed to load version history",
  "indicatorIde.close": "Close",
  ...
  "indicatorIde.devGuideTooltip": "Read the indicator coding tutorial",
  ...
  "indicatorIde.structuredTuneExplain": "Indicator tuning optimizes chart parameters only. Convert to Strategy API V2 before batch-testing stop-loss, take-profit, sizing, or execution parameters.",
  ...
  "indicatorIde.backtestMarkerAction.reduceLong": "Reduce L",
  "indicatorIde.backtestMarkerAction.closeLong": "Exit L",
  "indicatorIde.backtestMarkerAction.closeLongStop": "Exit L·SL",
  "indicatorIde.backtestMarkerAction.closeLongProfit": "Exit L·TP",
  "indicatorIde.backtestMarkerAction.closeLongTrailing": "Exit L·Trail",
  "indicatorIde.backtestMarkerAction.openShort": "Short",
  "indicatorIde.backtestMarkerAction.addShort": "Add S",
  "indicatorIde.backtestMarkerAction.reduceShort": "Reduce S",
  "indicatorIde.backtestMarkerAction.closeShort": "Exit S",
  "indicatorIde.backtestMarkerAction.closeShortStop": "Exit S·SL",
  "indicatorIde.backtestMarkerAction.closeShortProfit": "Exit S·TP",
  "indicatorIde.backtestMarkerAction.closeShortTrailing": "Exit S·Trail",
  "indicatorIde.backtestMarkerAction.liquidation": "Liq",
  "indicatorIde.backtestMarkerAction.other": "Fill",
  ...
  "indicatorIde.bestTrade": "Best Trade",
  "indicatorIde.worstTrade": "Worst Trade",
  "indicatorIde.avgTradePnl": "Avg P/L",
  ...
  "indicatorIde.purchasedReadOnlyTag": "Purchased",
  "indicatorIde.hiddenCodeTag": "Source hidden",
  "indicatorIde.hiddenCodeTitle": "Source code is hidden by the author",
  "indicatorIde.hiddenCodeDesc": "You can run the chart indicator and adjust available parameters in the parameter panel. Backtesting and live trading require converting it to a Strategy API V2 first.",
  "indicatorIde.saveBlockedHiddenCode": "This asset hides its source code, so the code cannot be edited directly.",
  "indicatorIde.hiddenCodeCannotOptimize": "Hidden-source assets cannot use frontend smart optimization.",
  "indicatorIde.purchasedIndicatorHintTitle": "This indicator is from the Indicator Market",
  "indicatorIde.purchasedIndicatorHintDesc": "This is your purchased copy. Visible-source assets can be edited and saved to your code history; syncing the author version also keeps your local history.",
  "indicatorIde.saveBlockedPurchased": "Purchased assets can be saved directly. If you see this message, refresh and try again.",
  "indicatorIde.publishBlockedPurchased": "Purchased indicators cannot be published to the Market again.",
  "indicatorIde.aiGenBlockedPurchased": "Hidden-source assets cannot be changed with AI directly.",
  "indicatorIde.equityCurve": "Equity Curve",
  "indicatorIde.strategyEquity": "Strategy Equity",
  "indicatorIde.spotBenchmark": "Spot Benchmark",
  "indicatorIde.alphaVsSpot": "Vs Spot",
  "indicatorIde.resultOverview": "Overview",
  "indicatorIde.resultChart": "Chart",
  "indicatorIde.resultTrades": "Trades",
  "indicatorIde.resultDiagnostics": "Diagnostics",
  "indicatorIde.resultOverviewTitle": "Backtest Workbench",
  "indicatorIde.openChartWorkspace": "Open chart",
  "indicatorIde.openSmartOptimize": "Smart optimize",
  "indicatorIde.chartFocusTitle": "Inspect entries and exits on the K-line chart",
  "indicatorIde.chartFocusDesc": "Use the chart workspace to review fills, signal bars, indicator overlays, and market context without leaving this backtest.",
  "indicatorIde.nextStepTitle": "Next step",
  "indicatorIde.viewDiagnostics": "View diagnostics",
  "strategyWorkbench.title": "Strategy Workbench",
  "strategyWorkbench.desc": "Manage indicator code, trading scripts, and bot presets in one place",
  "strategyWorkbench.assetAll": "All",
  "strategyWorkbench.assetIndicator": "Indicator",
  "strategyWorkbench.assetScript": "Script",
  "strategyWorkbench.assetBot": "Template",
  "strategyWorkbench.assetEmpty": "No strategy assets yet",
  "strategyWorkbench.assetPurchased": "Purchased",
  "strategyWorkbench.assetHidden": "Hidden source",
  "strategyWorkbench.assetUnknown": "Unknown",
  "strategyWorkbench.currentMode": "Current workspace",
  "strategyWorkbench.quickIndicatorTitle": "Indicator Code",
  "strategyWorkbench.quickIndicatorDesc": "Build chart-only indicators and publish them to the Market. Convert to a strategy before backtesting or live trading.",
  "strategyWorkbench.quickScriptTitle": "Trading Script",
  "strategyWorkbench.quickScriptDesc": "Write live-ready scripts and choose symbol, amount, and direction at run time.",
  "strategyWorkbench.quickBotTitle": "Template Strategy",
  "strategyWorkbench.quickBotDesc": "Manage grid, martingale, and other template strategies as reusable presets.",
  "indicatorIde.smartOptimizeTitle": "Smart Optimize",
  "indicatorIde.smartOptimizeDesc": "Choose an objective, then run structured search or AI candidate tuning.",
  "indicatorIde.strategyReturn": "Strategy return",
  "indicatorIde.spotReturn": "Spot return",
  "indicatorIde.insightEmpty": "Run a backtest to generate a strategy readout.",
  "indicatorIde.insightStrongAlpha": "The strategy is ahead of spot with controlled drawdown. It is a good candidate for deeper validation.",
  "indicatorIde.insightPositiveAlphaHighRisk": "The strategy beats spot, but drawdown needs risk review before moving closer to live trading.",
  "indicatorIde.insightPositiveButLagging": "The strategy is profitable but lags spot. Check whether active trading is adding enough value.",
  "indicatorIde.insightNegativeReturn": "The strategy lost money in this window. Start with diagnostics before optimizing parameters.",
  "indicatorIde.insightNeedMoreTrades": "The result is positive, but more samples are needed before trusting the edge.",
  "indicatorIde.diagnosticBenchmarkTitle": "Spot benchmark",
  "indicatorIde.diagnosticBenchmarkMissing": "No benchmark curve is available for this run.",
  "indicatorIde.diagnosticBenchmarkGood": "Strategy return is ahead of the same-period spot benchmark.",
  "indicatorIde.diagnosticBenchmarkWarn": "Strategy return is below the same-period spot benchmark.",
  "indicatorIde.diagnosticDrawdownTitle": "Drawdown risk",
  "indicatorIde.diagnosticDrawdownGood": "Drawdown is currently controlled.",
  "indicatorIde.diagnosticDrawdownWarn": "Drawdown is visible and should be reviewed by trade cluster.",
  "indicatorIde.diagnosticDrawdownDanger": "Drawdown is high. Tighten exits or reduce sizing before further use.",
  "indicatorIde.diagnosticSampleTitle": "Sample size",
  "indicatorIde.diagnosticSampleGood": "Trade sample is large enough for first-pass comparison.",
  "indicatorIde.diagnosticSampleWarn": "Sample size is modest. Validate on another window.",
  "indicatorIde.diagnosticSampleDanger": "Sample size is too small to trust the result.",
  "indicatorIde.diagnosticSharpeTitle": "Risk-adjusted quality",
  "indicatorIde.diagnosticSharpeGood": "Risk-adjusted return is healthy.",
  "indicatorIde.diagnosticSharpeWarn": "Risk-adjusted return is acceptable but not strong.",
  "indicatorIde.diagnosticSharpeDanger": "Risk-adjusted return is weak.",
  "indicatorIde.optimizeStepObjective": "Choose optimization objective",
  "indicatorIde.optimizeStepMethod": "Choose search method and dimensions",
  "indicatorIde.optimizeStepMethodDesc": "Use structured search for reproducible sweeps, or AI tuning for candidate ideas.",
  "indicatorIde.optimizeObjectiveBalanced": "Balanced",
  "indicatorIde.optimizeObjectiveBalancedHint": "Prefer stable return, reasonable drawdown, and enough trade samples.",
  "indicatorIde.optimizeObjectiveAlpha": "Beat spot",
  "indicatorIde.optimizeObjectiveAlphaHint": "Prioritize excess return versus the same-period spot benchmark.",
  "indicatorIde.optimizeObjectiveDrawdown": "Lower drawdown",
  "indicatorIde.optimizeObjectiveDrawdownHint": "Prioritize capital protection and smoother equity.",
  "indicatorIde.optimizeObjectiveSharpe": "Max Sharpe",
  "indicatorIde.optimizeObjectiveSharpeHint": "Prioritize risk-adjusted performance over raw return.",
  ...
  "indicatorIde.publishQualityPassed": "Code check passed. You can publish now.",
  "indicatorIde.publishQualityBlocked": "Code check failed. Publishing has been stopped.",
  "indicatorIde.publishQualityBlockedWithReason": "Code check failed: {reason}",
  "indicatorIde.publishQualityCheckFailed": "Code check is unavailable. Publishing has been stopped",
  ...
  "indicatorIde.quality.MISSING_BUY_SELL_COLUMNS": "Legacy df['buy']/df['sell'] columns are ignored. Indicators are chart-only; convert to Strategy API V2 for execution.",
  "indicatorIde.quality.UNKNOWN_STRATEGY_KEY": "Unknown @strategy key \"{key}\" (ignored by parser)",
  "indicatorIde.quality.EXECUTION_COLUMNS_IGNORED_FOR_INDICATOR": "Indicators are chart-only. Open/close/add/reduce columns are not executed. Generate a Strategy API V2 before backtesting or live trading.",
  "indicatorIde.quality.STRATEGY_ANNOTATIONS_IGNORED_FOR_INDICATOR": "# @strategy annotations are ignored in indicators. Put risk, sizing, timeframe, and execution rules in script strategies.",
  "indicatorIde.indicatorBacktestRemoved": "Indicators are chart-only. Generate a Strategy API V2 before backtesting.",
  "indicatorIde.generateStrategyV2Hint": "AI Copilot is ready to convert this indicator into a Strategy API V2 for later backtesting or live trading.",
  "indicatorIde.aiConvertToStrategy": "AI Indicator to Strategy",
  "indicatorIde.aiConvertHiddenBlocked": "Source-hidden indicators cannot be converted by AI. Please use a visible-source indicator.",
  ...
  "indicatorIde.quality.PARAM_DEFAULT_MISMATCH": "Parameter default mismatch: {details}. Make the # @param default exactly match the params.get(..., default) fallback, otherwise chart, backtest, and live execution may use different values.",
  ...
  "indicatorIde.paramPanel.title": "Indicator Parameters",
  "indicatorIde.paramPanel.currentIndicator": "Current indicator",
  "indicatorIde.paramPanel.hiddenSource": "Hidden source",
  "indicatorIde.paramPanel.visibleSource": "Visible source",
  "indicatorIde.paramPanel.boundary": "These settings only affect indicator calculation and chart display. They do not run backtests, live trading, or order execution.",
  "indicatorIde.paramPanel.noParams": "This indicator has no tunable parameters. Add # @param declarations at the top of the code.",
  "indicatorIde.paramPanel.defaultValue": "Default",
  "indicatorIde.paramPanel.range": "Range",
  "indicatorIde.paramPanel.reset": "Reset",
  "indicatorIde.paramPanel.saveDefault": "Save default",
  "indicatorIde.paramPanel.writeBack": "Write to code",
  "indicatorIde.paramPanel.writeBackHint": "Write current values back to # @param defaults. Save the indicator to persist source defaults.",
  "indicatorIde.paramPanel.writeBlockedHidden": "Hidden-source indicators cannot write back to code, but you can apply and save your own defaults.",
  "indicatorIde.paramPanel.apply": "Apply to chart",
  "indicatorIde.paramPanel.applySuccess": "Parameters applied. Refreshing chart",
  "indicatorIde.paramPanel.saveSuccess": "Saved as your default parameters",
  "indicatorIde.paramPanel.writeSuccess": "Parameters written to code. Save the indicator to persist",
  ...
  "indicatorIde.structuredTuneTpeHint": "TPE-style Bayesian sampling picks the next candidate from past good vs. bad trials — typically finds promising regions faster than pure random.",
  ...
  "indicatorIde.optimizationLab": "Optimization Lab",
  "indicatorIde.optimizationLabHint": "Every chart is derived from this run’s backtests, scoring, and OOS checks. It audits the search process; it is not a promise of future returns.",
  "indicatorIde.analyticsDataSource": "Backtest-derived",
  "indicatorIde.optimizerModel": "Optimizer",
  "indicatorIde.optimizerModelHint": "Candidate generation method",
  "indicatorIde.evaluationBudget": "Evals / Dims",
  "indicatorIde.evaluationBudgetHint": "Backtested candidates / tuned dimensions",
  "indicatorIde.scoreDispersion": "Score Dispersion",
  "indicatorIde.scoreDispersionHint": "Standard deviation of candidate scores",
  "indicatorIde.oosAudit": "OOS Checks",
  "indicatorIde.oosAuditHint": "Candidates retested on the holdout window",
  "indicatorIde.analyticsConvergence": "Search Convergence",
  "indicatorIde.analyticsConvergenceHint": "Trial score vs best-so-far",
  "indicatorIde.analyticsOosMatrix": "IS/OOS Generalization",
  "indicatorIde.analyticsOosMatrixHint": "Closer to the diagonal is more robust",
  "indicatorIde.analyticsParamSensitivity": "Parameter Sensitivity",
  "indicatorIde.analyticsParamSensitivityHint": "Bucketed from evaluated candidates",
  "indicatorIde.analyticsRiskReturn": "Risk vs return",
  "indicatorIde.analyticsRiskReturnHint": "Top-left is best (low drawdown, high return)",
  ...
  "indicatorIde.analyticsNoScatter": "No risk-return data available",
  "indicatorIde.analyticsNoConvergence": "No evaluation trace available",
  "indicatorIde.analyticsNoOosMatrix": "No OOS comparison available",
  "indicatorIde.analyticsNoParamSensitivity": "No parameter sensitivity data",
  "indicatorIde.analyticsTrialScore": "Trial Score",
  "indicatorIde.analyticsBestSoFar": "Best So Far",
  "indicatorIde.analyticsScoreSpread": "Score Spread",
  "indicatorIde.analyticsBestValue": "Best Value",
  "indicatorIde.analyticsWorstValue": "Weakest Value",
  "indicatorIde.analyticsCorrelation": "Correlation",
  "indicatorIde.optimizerMethodLlm": "LLM Multi-round",
  "indicatorIde.optimizerMethodGrid": "Grid Search",
  "indicatorIde.optimizerMethodRandom": "Random Search",
  "indicatorIde.optimizerMethodDe": "Differential Evolution",
  "indicatorIde.optimizerMethodTpe": "TPE-style Bayesian",
  "indicatorIde.scoringProfile": "Scoring weights",
  "indicatorIde.stability": "Stability",
  "indicatorIde.structuredTuneHint": "Indicator candidate parameters can feed Strategy API V2 generation; run strategy batch backtests from the Strategy API V2 backtest page.",
  ...
  "indicatorIde.bestParamsApplied": "Candidate values written into indicator code (# @param). Indicators are chart-only; convert to Strategy API V2 before backtesting or live trading.",
  ...
  "indicatorIde.positionParamsGroup": "Position params (AI)",
  ...
  "indicatorIde.backtestThisCandidate": "Strategy Candidate",
  ...
  "indicatorIde.strategyAnnotationsHint": "This indicator has @strategy lines; they are used as engine-risk hints only after conversion to Strategy API V2.",
  "indicatorIde.strategyFromCodeHint": "Indicator code is chart-only. Put stop-loss, take-profit, sizing, and execution rules in Strategy API V2 code.",
  ...
  "profile.exchange.demoTradingHint": "Uses each exchange demo/test endpoints where available (e.g. Binance demo hosts, Bybit testnet, OKX simulated-trading header). Use demo credentials issued by each supported venue and keep this checked to tag the credential.",
  "profile.exchange.environment": "Trading environment",
  "profile.exchange.environmentLive": "Live trading",
  "profile.exchange.environmentDemo": "Demo trading",
  "profile.exchange.environmentTestnet": "Testnet",
  "profile.exchange.marketScope": "Credential market scope",
  "profile.exchange.marketScopeSpot": "Spot only",
  "profile.exchange.marketScopeSwap": "Futures only",
  "profile.exchange.marketScopeBoth": "Spot and futures",
  "profile.exchange.environmentHint.binance": "A Binance Demo Trading key can cover Spot and USD-M Futures when both permissions are enabled.",
  "profile.exchange.environmentHint.binanceLive": "A live API key can cover Spot and USD-M Futures when both permissions are enabled.",
  "profile.exchange.environmentHint.binanceDemo": "Create the key in Binance Demo Trading. Spot uses demo-api.binance.com and USD-M Futures uses demo-fapi.binance.com.",
  "profile.exchange.environmentHint.okx": "Create the API key inside OKX Demo Trading; demo requests use the simulated-trading header.",
  "profile.exchange.environmentHint.bitget": "Create a Demo API key after switching Bitget to Demo mode.",
  "profile.exchange.environmentHint.bybit": "Create the key from Demo Trading in your mainnet account; requests use api-demo.bybit.com.",
  "profile.exchange.environmentHint.gate": "Use a Gate TestNet APIv4 key; live API keys cannot access TestNet.",
  "profile.exchange.environmentHint.htx": "HTX does not publish a user-accessible demo trading API, so only live trading is available.",
  "profile.exchange.errors.HTX_DEMO_NOT_SUPPORTED": "HTX does not provide a public demo/testnet trading API.",
  "profile.exchange.errors.UNSUPPORTED_TRADING_ENVIRONMENT": "This exchange does not support the selected environment.",
  "profile.exchange.errors.BINANCE_SPOT_AUTH_MISMATCH": "Binance rejected the Spot credential. Confirm the selected environment matches where the key was created and that Spot trading permission is enabled.",
  "profile.exchange.errors.CREDENTIAL_MARKET_SCOPE_MISMATCH": "This credential does not support the selected market.",
  "profile.exchange.errors.CREDENTIAL_CONNECTION_FAILED": "The exchange rejected the connection.",
  "profile.exchange.errors.NETWORK_ERROR": "Network error. Check the connection and try again.",
  ...
  "profile.exchange.testSuccess": "The selected environment and account permissions connected successfully; other environments require their own valid credentials.",
  ...
  "profile.exchange.editName": "Edit name",
  "profile.exchange.renameTitle": "Edit account name",
  "profile.exchange.renameHint": "Only updates the display label. API keys and secrets are not changed.",
  "profile.exchange.renameSuccess": "Account name updated",
  "profile.exchange.renameFailed": "Failed to update account name",
  ...
  "profile.exchange.alpacaNoLocalHint": "Alpaca connects via cloud REST API - no TWS / IB Gateway terminal needed. Recommended US-stock/crypto broker for SaaS deployments. Apply for an API key at https://alpaca.markets — this system auto-routes by prefix: PK* -> paper-api (sandbox), AK* -> api (live).",
  ...
  "profile.exchange.desktopBrokersDisabledTitle": "IBKR disabled on this server",
  "profile.exchange.desktopBrokersDisabledFallback": "Deploy QuantDinger on your own machine or private server and install TWS, IB Gateway, or Alpaca.",
  "profile.exchange.desktopBrokersOptionSuffix": "Unavailable here",
  "profile.exchange.goToManage": "Go to Broker Accounts to manage",
  "profile.exchange.noCredentialHint": "Please add an exchange account in Broker Accounts first",
  ...
  "adminAiStats.aiActivity": "AI Activity",
  "adminAiStats.activeUsers": "Active Users",
  "adminAiStats.uniqueSymbols": "Symbols Analyzed",
  "adminAiStats.copilotMessages": "Copilot Messages",
  ...
  "settings.desc.OPENROUTER_MODEL": "Default AI model in provider/model format, e.g. openai/gpt-5.4 or anthropic/claude-sonnet-4.5.",
  ...
  "settings.desc.CCXT_DEFAULT_EXCHANGE": "CCXT default exchange (binance, okx, bybit, etc.)",
  ...
  "settings.desc.FINNHUB_API_KEY": "Optional Finnhub API key for US stock quotes, company profile and news. Paid endpoints such as Economic Calendar are skipped by default.",
  "settings.desc.FINNHUB_FREE_ONLY": "Keep enabled for free Finnhub plans. Paid-only endpoints such as Economic Calendar and Social Sentiment will not be called.",
  ...
  "settings.desc.TRADING_ECONOMICS_CLIENT": "Optional international economic calendar provider. Leave empty to use the free fallback; enter your Trading Economics client name if you have credentials.",
  "settings.desc.TRADING_ECONOMICS_KEY": "Optional Trading Economics API key. Leave empty unless you have official credentials.",
  "settings.desc.TRADING_ECONOMICS_BASE_URL": "Trading Economics API endpoint. Change only when using a proxy or mirror.",
  "settings.desc.TRADING_ECONOMICS_TIMEOUT": "Timeout for economic calendar requests.",
  "settings.desc.FRED_API_KEY": "FRED API key for stable US macro time series such as rates, inflation, labor and financial conditions.",
  "settings.desc.FRED_BASE_URL": "FRED API endpoint. Usually no need to change.",
  "settings.desc.FRED_TIMEOUT": "Timeout for FRED requests.",
  "settings.desc.BLS_API_KEY": "BLS API key for official CPI, employment and labor statistics. Leave empty to use public limits.",
  "settings.desc.BLS_BASE_URL": "BLS API endpoint. Usually no need to change.",
  "settings.desc.BLS_TIMEOUT": "Timeout for BLS requests.",
  "settings.desc.BEA_API_KEY": "BEA API key for official GDP, PCE and national accounts data.",
  "settings.desc.BEA_BASE_URL": "BEA API endpoint. Usually no need to change.",
  "settings.desc.BEA_TIMEOUT": "Timeout for BEA requests.",
  "settings.desc.COINGLASS_API_KEY": "Coinglass API key for crypto derivatives, funding rate, long/short ratio, and exchange flow data.",
  "settings.desc.CRYPTOQUANT_API_KEY": "CryptoQuant API key for on-chain and stablecoin flow metrics used in crypto market analysis.",
  "settings.desc.TUSHARE_TOKEN": "Tushare token. When set, CNStock daily bars prefer Tushare.",
  "settings.desc.TUSHARE_HTTP_URL": "Optional Tushare-compatible API base URL (e.g. https://ts.gyzcloud.top/api). Leave empty for the official endpoint.",
  "settings.desc.TWELVE_DATA_API_KEY": "Twelve Data API key for CN/HK stock K-lines and other market data. Free quota is limited.",
  "settings.desc.ADANOS_API_KEY": "Adanos market sentiment API key. Leave empty to disable the US-stock sentiment widget.",
  "settings.desc.ADANOS_SENTIMENT_SOURCE": "Sentiment source channel, such as reddit. See Adanos docs for valid values.",
  "settings.desc.ADANOS_API_BASE_URL": "Adanos API endpoint. Change only if you use a self-hosted service or mirror.",
  ...
  "trading-assistant.template.classic_ema_atr_trend": "Classic EMA ATR Trend",
  "trading-assistant.template.classic_ema_atr_trendDesc": "EMA trend-following strategy with ATR stop, trailing stop, and cooldown.",
  "trading-assistant.template.donchian_breakout_pyramid": "Donchian Breakout Pyramid",
  "trading-assistant.template.donchian_breakout_pyramidDesc": "Channel breakout strategy with pyramiding, hard stop, and exit channel.",
  "trading-assistant.template.bollinger_reversion_basket": "Bollinger Reversion Basket",
  "trading-assistant.template.bollinger_reversion_basketDesc": "Bollinger mean-reversion basket with controlled add layers and average-cost exit.",
  "trading-assistant.template.range_grid_basket": "Range Grid Basket",
  "trading-assistant.template.range_grid_basketDesc": "Script-level range grid simulation triggered on closed bars. It does not pre-place exchange resting limits; use Grid Bot for live long/short/neutral grids.",
  "trading-assistant.template.dca_accumulator": "DCA Accumulator",
  "trading-assistant.template.dca_accumulatorDesc": "Periodic DCA accumulator with dip multiplier and portfolio-level exit controls.",
  "trading-assistant.template.sequential_martingale": "Sequential Martingale",
  "trading-assistant.template.sequential_martingaleDesc": "Budget-capped sequential martingale with explicit total budget, first-order sizing, adverse-price adds, average-cost take-profit, and hard stop.",
  "trading-assistant.template.layered_martingale_basket": "Layered Martingale Basket",
  "trading-assistant.template.layered_martingale_basketDesc": "Split-position martingale with several child entries inside each layer.",
  "trading-assistant.template.keltner_retest_breakout": "Keltner Retest Breakout",
  "trading-assistant.template.keltner_retest_breakoutDesc": "Keltner channel breakout that waits for retest confirmation and exits with ATR trail.",
  "trading-assistant.template.runtimeSequentialMartingaleBasket": "Layered basket martingale",
  "trading-assistant.template.runtimeSequentialMartingaleBasketDesc": "Defaults to 5 layers and 3 orders per layer; child order notional follows martingale sizing with average-cost take profit.",
  "trading-assistant.template.macdMomentumSwing": "MACD momentum swing",
  "trading-assistant.template.macdMomentumSwingDesc": "MACD histogram zero-cross entry with EMA trend filter, fixed target, and hard stop.",
  "trading-assistant.template.keltnerChannelBreakout": "Keltner channel breakout",
  "trading-assistant.template.keltnerChannelBreakoutDesc": "ATR channel breakout with EMA midline filter and ATR trailing exit.",
  "trading-assistant.template.rsiScaleReversion": "RSI scale reversion",
  "trading-assistant.template.rsiScaleReversionDesc": "RSI oversold/overbought reversal basket with limited adverse layers and average-cost exit.",
  "trading-assistant.templateParam.hard_stop_price_pct.label": "Hard-stop price move",
  "trading-assistant.templateParam.hard_stop_price_pct.desc": "Adverse price move from average entry. 0.10 means 10% price move, not 10% margin loss.",
  "trading-assistant.templateParam.step_pct.label": "Add step",
  "trading-assistant.templateParam.step_pct.desc": "Favorable price move required before adding the next layer.",
  ...
  "trading-assistant.templateParam.layer_multiplier.label": "Layer multiplier",
  "trading-assistant.templateParam.layer_multiplier.desc": "How much each later layer increases relative to the base notional.",
  "trading-assistant.templateParam.layer_step_pct.label": "Layer trigger gap",
  "trading-assistant.templateParam.layer_step_pct.desc": "Adverse price move before the next layer triggers; 1.8 means 1.8%.",
  "trading-assistant.templateParam.pyramid_step_pct.label": "Pyramid step",
  "trading-assistant.templateParam.pyramid_step_pct.desc": "Favorable price move required before adding the next pyramid layer; 1.5 means 1.5%.",
  "trading-assistant.templateParam.direction.label": "Trade direction",
  "trading-assistant.templateParam.direction.desc": "Run this basket martingale as a long or short sequence.",
  "trading-assistant.templateParam.direction.optionLong": "Long",
  "trading-assistant.templateParam.direction.optionShort": "Short",
  "trading-assistant.templateParam.orders_per_layer.label": "Orders per layer",
  "trading-assistant.templateParam.orders_per_layer.desc": "How many child orders each basket layer contains; this preset defaults to 3.",
  "trading-assistant.templateParam.martingale_multiplier.label": "Martingale multiplier",
  "trading-assistant.templateParam.martingale_multiplier.desc": "Child order notional increases inside each layer, for example 1, 1.8, 3.24.",
  "trading-assistant.templateParam.intra_spacing_1_pct.label": "Order 1 to 2 gap",
  "trading-assistant.templateParam.intra_spacing_1_pct.desc": "Adverse price gap from the first child order to the second; 0.5 means 0.5%.",
  "trading-assistant.templateParam.intra_spacing_2_pct.label": "Order 2 to 3 gap",
  "trading-assistant.templateParam.intra_spacing_2_pct.desc": "Adverse price gap from the second child order to the third; 0.8 means 0.8%.",
  "trading-assistant.templateParam.inter_spacing_pct.label": "Base layer gap",
  "trading-assistant.templateParam.inter_spacing_pct.desc": "Adverse price gap to enter the next layer after the current layer is fully opened without average-price TP.",
  "trading-assistant.templateParam.inter_spacing_growth_pct.label": "Layer gap growth",
  "trading-assistant.templateParam.inter_spacing_growth_pct.desc": "Extra percentage added to the inter-layer gap for each deeper layer.",
  "trading-assistant.templateParam.trend_period.label": "Trend EMA",
  "trading-assistant.templateParam.trend_period.desc": "EMA length used as the higher-level trend filter.",
  "trading-assistant.templateParam.ema_period.label": "Channel EMA",
  "trading-assistant.templateParam.ema_period.desc": "EMA length used as the Keltner channel center line.",
  "trading-assistant.templateParam.channel_mult.label": "Channel ATR multiple",
  "trading-assistant.templateParam.channel_mult.desc": "ATR multiple used to place the upper and lower Keltner channel.",
  "trading-assistant.templateParam.trail_mult.label": "Trailing ATR multiple",
  "trading-assistant.templateParam.trail_mult.desc": "ATR multiple used to trail the open position.",
  "trading-assistant.templateParam.exit_rsi.label": "Exit RSI",
  "trading-assistant.templateParam.exit_rsi.desc": "RSI level considered normalized enough to exit profitable reversion trades.",
  ...
  "trading-assistant.form.scriptTemplateDirectionHint": "Template direction is {direction}; it has been synced to run direction, which still acts as the outer safety gate.",
  "brokerAccounts.title": "Live Broker Accounts",
  "brokerAccounts.subtitle": "Manage your crypto exchange credentials and live connections to Alpaca / Interactive Brokers / Alpaca — accounts, positions, and open orders — in one place.",
  "brokerAccounts.cryptoSection.title": "Crypto Exchange Accounts",
  "brokerAccounts.cryptoSection.subtitle": "These accounts are stored as encrypted credentials and used by template and live strategies. Supports Binance / Bitget / Bybit / OKX / Gate.io / HTX.",
  ...
  "brokerAccounts.orderHistoryCount": "{count} recent orders",
  "brokerAccounts.cloudOnlyAlert": "This deployment disables desktop brokers (IBKR). Only Alpaca REST is available. Set ALLOW_LOCAL_DESKTOP_BROKERS=true on the backend to enable them.",
  ...
  "brokerAccounts.tabOrders": "Orders",
  "universeManager.nameRequired": "Enter a universe name.",
  "exception.backHome": "Back Home",
  "exception.403.subtitle": "Sorry, you do not have access to this page.",
  "exception.404.subtitle": "Sorry, the page you visited does not exist.",
  "exception.500.subtitle": "Sorry, the server is reporting an error.",
  ...
  "authorDashboard.unpublishFailed": "Failed to unpublish",
  "authorDashboard.unpublishSuccess": "Unpublished successfully",
  "authorDashboard.unpublishConfirmContent": "It will be removed from the public market and new users will not be able to buy it. Existing buyers keep their local copies and purchase rights.",
  "authorDashboard.unpublishConfirmTitle": "Unpublish this asset?",
  ...
  "profile.agentTokens.intro": "Issue an Agent Token so Cursor / Claude Code / MCP clients can call /api/agent/v1 for your account. The full token is shown only once — store it securely.",
  "profile.agentTokens.saasWarningTitle": "SaaS T-scope disclosure",
  "profile.agentTokens.saasWarningIntro": "This is a multi-tenant hosted instance. You may issue T (Trading) scope tokens for your own tenant. Please review these risks:",
  "profile.agentTokens.liveRiskTitle": "Live trading risk acknowledgment",
  "profile.agentTokens.liveRiskAck": "I have read and accept the risks above and want a live-eligible T-scope token",
  "profile.agentTokens.liveRiskAckRequired": "Please check the risk acknowledgment box first",
  "profile.agentTokens.risk.systemLoad": "Many concurrent agents increase load on DB pools, job workers, and strategy threads.",
  "profile.agentTokens.risk.rateLimit": "Automated traffic may hit platform and exchange rate limits, affecting other tenants.",
  "profile.agentTokens.risk.audit": "Audit logs do not replace human review of agent behavior.",
  "profile.agentTokens.risk.saasT": "Opening T scope on SaaS expands platform operational and compliance responsibility.",
  "profile.agentTokens.risk.misconfig": "Agent misconfiguration or prompt injection may trigger unintended live orders and financial loss.",
  "profile.agentTokens.risk.leak": "A leaked token grants API access within its scopes until revoked.",
  "profile.agentTokens.risk.liveSwitch": "Live trading requires paper_only=false on the token AND AGENT_LIVE_TRADING_ENABLED=true on the server.",
  ...
  "profile.loginLogs.location": "Location",
  "profile.loginLogs.ip": "IP",
  "profile.loginLogs.flags": "Alert",
  ...
  "trading-bot.detail.ledgerExchangeMismatchDesc": "Cards above are ledger positions from fills; below is a live exchange query. On one-way mode, neutral grid initial long+short may net to zero on the exchange — switch to hedge/dual-side mode and restart.",
  ...
  "trading-assistant.tabs.aiReview": "AI Review",
  "trading-bot.tab.aiReview": "AI Review",
  "strategyReview.title": "AI Strategy Review",
  "strategyReview.subtitle": "Auditable review built from review-window trades, positions, and the performance equity curve.",
  "strategyReview.generate": "Generate Review",
  "strategyReview.regenerate": "Regenerate",
  "strategyReview.includeAi": "Use LLM summary",
  "strategyReview.lookback7": "Last 7d",
  "strategyReview.lookback30": "Last 30d",
  "strategyReview.lookback90": "Last 90d",
  "strategyReview.emptyDesc": "Generate a review for the selected window. No strategy parameters will be changed automatically.",
  "strategyReview.loadFailed": "Failed to generate strategy review",
  "strategyReview.aiSummary": "AI Summary",
  "strategyReview.aiSummaryEmpty": "No AI summary yet",
  "strategyReview.aiDiagnosis": "Diagnosis",
  "strategyReview.aiRecommendations": "Recommendations",
  "strategyReview.ruleDiagnostics": "Rule Diagnostics",
  "strategyReview.ruleDiagnosticsHint": "Computed by backend metrics",
  "strategyReview.ruleRecommendations": "Improvement Ideas",
  "strategyReview.ruleRecommendationsHint": "Advice only; parameters are not changed",
  "strategyReview.noDiagnostics": "No diagnostics",
  "strategyReview.noRecommendations": "No recommendations",
  "strategyReview.aiStatus.ok": "AI generated",
  "strategyReview.aiStatus.fallback": "Rule fallback (no LLM)",
  "strategyReview.aiStatus.skipped": "AI skipped",
  "strategyReview.aiFallbackDetail": "The LLM call did not succeed, so the rule-based review was used.",
  "strategyReview.aiSkippedDetail": "The LLM was not requested for this review.",
  "strategyReview.metric.netPnl": "Window Realized Net PnL",
  "strategyReview.metric.netPnlHint": "Realized PnL after fees inside the selected review window",
  "strategyReview.metric.returnPct": "Performance Return",
  "strategyReview.metric.returnPctHint": "Aligned with the performance page, based on the full equity curve",
  "strategyReview.metric.winRate": "Win Rate",
  "strategyReview.metric.profitFactor": "Profit Factor",
  "strategyReview.metric.profitFactorHint": "Gross profit / gross loss",
  "strategyReview.metric.maxDrawdown": "Performance Max Drawdown",
  "strategyReview.metric.fees": "Fees",
  "strategyReview.metric.feesHint": "About {ratio} of net PnL",
  "strategyReview.metric.openPositions": "Open Positions",
  "strategyReview.metric.gridPairs": "Grid Pairs",
  "strategyReview.metric.gridPairsHint": "{negative} negative pair(s)",
  "strategyReview.severity.danger": "Danger",
  "strategyReview.severity.warning": "Warning",
  "strategyReview.severity.info": "Info",
  "strategyReview.severity.success": "OK",
  "strategyReview.priority.high": "High",
  "strategyReview.priority.medium": "Medium",
  "strategyReview.priority.low": "Low",
  "strategyReview.historyPlaceholder": "Saved reviews",
  "strategyReview.historyEmpty": "No saved reviews",
  "strategyReview.historyRefresh": "Refresh saved reviews",
  "strategyReview.historyLoadFailed": "Failed to load saved review",
  "strategyReview.historyGeneratedAt": "Generated at {time}",
  "strategyReview.historySaved": "Saved",
  "strategyReview.historyLookback": "{days}d",
  "strategyCenter.backtest.detailLoaded": "Backtest details loaded into the result panel.",
  "strategyCenter.backtest.adviceGood": "The result is stable enough to continue with a larger sample or parameter sensitivity check.",
  "strategyCenter.backtest.adviceNeutral": "This is a candidate result. Validate it across a longer period and different market regimes.",
  ...
  "aiAssetAnalysis.copilot.strategyFlowManualLaunch": "Manual launch",
  "aiAssetAnalysis.copilot.quickTasks.scheduled_watch.label": "Scheduled watch",
  "aiAssetAnalysis.copilot.quickTasks.news_events.label": "News / events search",
  "aiAssetAnalysis.copilot.quickTasks.macro_data.label": "Macro data",
  "backtest-center.audit.title": "Backtest Audit",
  "backtest-center.audit.subtitle": "Review this run across data coverage, execution assumptions, capital constraints, trade evidence, risk controls, and reproducibility.",
  ...
  "backtest-center.audit.redesignedSubtitle": "A compact professional check of data coverage, execution assumptions, capital constraints, trade evidence, risk controls, and reproducibility.",
  ...
  "backtest-center.tradeColumns.side": "Direction",
  "backtest-center.tradeColumns.closeReason": "Exit Reason",
  "backtest-center.tradeColumns.profit": "Profit",
  "backtest-center.tradeColumns.entryPrice": "Entry Price",
  "backtest-center.tradeColumns.exitPrice": "Exit Price",
  "backtest-center.tradeColumns.entryTime": "Entry Time",
  "backtest-center.tradeColumns.exitTime": "Exit Time",
  "backtest-center.tradeColumns.balance": "Wallet Balance",
  ...
  "backtest-center.metrics.totalReturn": "Total Return",
  "backtest-center.metrics.maxDrawdown": "Max Drawdown",
  "backtest-center.metrics.sharpe": "Sharpe Ratio",
  "backtest-center.metrics.winRate": "Win Rate",
  "backtest-center.metrics.profitFactor": "Profit Factor",
  "backtest-center.metrics.trades": "Total Trades",
  "backtest-center.metrics.bestTrade": "Best Trade",
  "backtest-center.metrics.worstTrade": "Worst Trade",
  "backtest-center.metrics.avgPnl": "Avg PnL",
  "backtest-center.metrics.vsSpot": "vs Spot",
  "backtest-center.metrics.vsSpotHint": "Strategy return minus same-period spot return",
  "backtest-center.insight.stable": "This run is relatively stable.",
  "backtest-center.insight.drawdownReview": "Profitable but drawdown needs review.",
  "backtest-center.insight.weak": "This run is weak. Review parameters or market filters.",
  "backtest-center.insight.candidate": "Candidate result. Review risk before use.",
  "backtest-center.diagnostic.drawdown": "Drawdown Risk",
  "backtest-center.diagnostic.samples": "Samples",
  "backtest-center.diagnostic.alpha": "Excess Return",
  ...
  "backtest-center.closeReason.trailingStop": "Trailing Stop",
  "backtest-center.closeReason.liquidation": "Liquidation",
  "backtest-center.closeReason.finalClose": "Final Close",
  "backtest-center.closeReason.signalClose": "Signal Close",
  "backtest-center.closeReason.emaPullbackExit": "EMA Pullback Exit",
  "backtest-center.closeReason.emaTrendBreak": "EMA Trend Break",
  "backtest-center.closeReason.maxHolding": "Max Holding",
  "backtest-center.closeReason.close": "Close",
  ...
  "backtest-center.noAssets": "No strategies yet. Create one in Trading Assistant first.",
  "backtest-center.createAsset": "Go to Trading Assistant",
  "backtest-center.selectStrategy": "Select Strategy",
  "backtest-center.strategyPlaceholder": "Choose a strategy to backtest",
  "backtest-center.currentStrategy": "Current Strategy",
  "backtest-center.selectStrategyFirst": "Select a strategy first",
  "backtest-center.noDescription": "No description",
  "backtest-center.history": "History",
  "backtest-center.engine": "Engine",
  "backtest-center.paramsCount": "Params",
  "backtest-center.marketConfig": "Symbol & Direction",
  "backtest-center.backtestParams": "Backtest Params",
  "backtest-center.symbol": "Symbol",
  "backtest-center.symbolPlaceholder": "Search symbol, e.g. BTC/USDT, AAPL",
  "backtest-center.addSymbol": "Add Symbol",
  ...
  "backtest-center.timeframe": "Timeframe",
  "backtest-center.timeframeFromCode": "Current timeframe:",
  "backtest-center.marketType": "Market Type",
  "backtest-center.spot": "Spot",
  "backtest-center.swap": "Swap",
  "backtest-center.capital": "Capital Settings",
  "backtest-center.initialCapital": "Initial Capital",
  "backtest-center.leverage": "Leverage",
  "backtest-center.direction": "Trade Direction",
  "backtest-center.long": "Long Only",
  "backtest-center.short": "Short Only",
  "backtest-center.both": "Both",
  "backtest-center.commission": "Commission",
  "backtest-center.slippage": "Slippage",
  "backtest-center.fundingRateAnnual": "Funding Rate (APR)",
  "backtest-center.fundingIntervalHours": "Funding Interval (h)",
  ...
  "backtest-center.strategyParams": "Strategy Params",
  "backtest-center.unsaved": "Unsaved",
  "backtest-center.strategyParamsHint": "Changes affect this run. Save as a new code version after confirmation.",
  "backtest-center.saveVersion": "Save Version",
  "backtest-center.backtestRange": "Backtest Range",
  "backtest-center.startDate": "Start date",
  "backtest-center.endDate": "End date",
  "backtest-center.runBacktest": "Run Backtest",
  "backtest-center.stopBacktest": "Stop Backtest",
  "backtest-center.stopping": "Stopping backtest…",
  "backtest-center.stopped": "Backtest stopped",
  "backtest-center.resultOverview": "Backtest Workbench",
  "backtest-center.emptyResult": "No backtest result yet. Run a backtest first.",
  "backtest-center.zeroTradeWarning": "No trades were generated in this run. Check timeframe, direction, and entry conditions.",
  "backtest-center.dataRangeAdjustedTitle": "Available data range adjusted",
  "backtest-center.dataRangeAdjustedDescription": "Requested {requestedStart} to {requestedEnd}; the data provider returned {actualStart} to {actualEnd} ({rows} candles). The backtest used only this available range.",
  "backtest-center.diagnostics": "Diagnostics",
  "backtest-center.equityCurve": "Equity Curve",
  ...
  "backtest-center.tradeReplay": "Trade Replay",
  "backtest-center.noReplayData": "No replay data",
  ...
  "backtest-center.openAction": "Open",
  "backtest-center.closeAction": "Close",
  "backtest-center.addAction": "Add",
  "backtest-center.reduceAction": "Reduce",
  "backtest-center.trades": "Trade History",
  "backtest-center.smartTune": "Smart Optimize",
  "backtest-center.tunableDimensions": "Tunable Dimensions",
  "backtest-center.execute": "Run",
  ...
  "backtest-center.noSearchResult": "No match found. The entered code will be used directly.",
  "backtest-center.symbolRequired": "Please enter a trading symbol",
  "backtest-center.addSuccess": "Added successfully",
  ...
  "backtest-center.audit.trailing": "Trailing Stop",
  "backtest-center.audit.enabled": "Enabled",
  "backtest-center.audit.maxHolding": "Max Holding Bars",
  "backtest-center.audit.riskSource": "Risk Source",
  "backtest-center.audit.codeDefault": "Code Default",
  "backtest-center.audit.notConfigured": "Not Configured",
  "backtest-center.audit.dataCoverage": "Data Coverage",
  "backtest-center.audit.passed": "Passed",
  "backtest-center.audit.attention": "Attention",
  "backtest-center.audit.candles": "candles",
  "backtest-center.audit.dataSparse": "Sparse Data",
  "backtest-center.audit.dataReadyDesc": "Candles were loaded for the selected range and can be used for path review.",
  "backtest-center.audit.dataSparseDesc": "Not enough candles were returned for a reliable path review.",
  "backtest-center.audit.range": "Range",
  "backtest-center.audit.pathReview": "Path Review",
  "backtest-center.audit.available": "Available",
  "backtest-center.audit.unavailable": "Unavailable",
  "backtest-center.audit.executionAssumptions": "Execution Assumptions",
  "backtest-center.audit.documented": "Documented",
  "backtest-center.audit.barBasedFill": "Bar-Based Fill",
  "backtest-center.audit.fillPolicy": "Fill Policy",
  "backtest-center.audit.fullFill": "Full Fill",
  "backtest-center.audit.commissionAndSlippage": "Commission / Slippage",
  "backtest-center.audit.capitalModel": "Capital Model",
  "backtest-center.audit.accounting": "Accounting",
  "backtest-center.audit.capitalModelDesc": "Checks order sizing against initial capital, leverage, direction, and margin budget.",
  "backtest-center.audit.marginBudget": "Margin Budget",
  "backtest-center.audit.tradeEvidence": "Trade Evidence",
  "backtest-center.audit.sufficient": "Sufficient",
  "backtest-center.audit.limited": "Limited",
  "backtest-center.audit.tradeSamples": "trade samples",
  "backtest-center.audit.replayReadyDesc": "Trade actions are mapped onto the candle path for entry and exit review.",
  "backtest-center.audit.replayEmptyDesc": "No replayable trade actions are available.",
  "backtest-center.audit.pairedTrades": "Paired Trades",
  "backtest-center.audit.replayMarkers": "Replay Markers",
  "backtest-center.audit.markers": "markers",
  "backtest-center.audit.noMarkers": "No markers",
  "backtest-center.audit.sampleQuality": "Sample Quality",
  "backtest-center.audit.sampleOk": "Sample OK",
  "backtest-center.audit.lowSample": "Low Sample",
  "backtest-center.audit.riskReport": "Risk Report",
  "backtest-center.audit.detected": "Detected",
  "backtest-center.audit.riskReadyDesc": "Risk controls were detected in code or panel settings.",
  "backtest-center.audit.riskCodeDefaultDesc": "Risk is mainly controlled by strategy code defaults.",
  "backtest-center.audit.reproducibility": "Reproducibility",
  "backtest-center.audit.captured": "Captured",
  "backtest-center.audit.partial": "Partial",
  "backtest-center.audit.paramSnapshot": "Param Snapshot",
  "backtest-center.audit.codeDataVersion": "Code / Data Version",
  "backtest-center.audit.runId": "Run ID",
  "backtest-center.audit.notReturned": "Not Returned",
  "backtest-center.audit.noStrategyParams": "No Strategy Params",
  "backtest-center.audit.codeYesDataNeeded": "Code recorded; market data should be reloaded by range.",
  "backtest-center.audit.spotBenchmark": "Spot Benchmark",
  "backtest-center.audit.benchmarkReadyDesc": "A same-period spot buy-and-hold benchmark is available for excess-return review.",
  "backtest-center.audit.strategyReturn": "Strategy Return",
  "backtest-center.audit.benchmarkReturn": "Benchmark Return",
...
export default {
  "strategyIde.workspaceLabel": "Strategy workspace",
  "portfolioTemplate.params.topN.label": "Number of holdings",
  "portfolioTemplate.params.topN.description": "Maximum number of highest-ranked eligible symbols to hold.",
  "portfolioTemplate.params.lookback.label": "Ranking lookback",
  "portfolioTemplate.params.lookback.description": "Historical bars used to calculate the cross-sectional ranking signal.",
  "strategyIde.ctaWorkspaceTitle": "CTA workspace",
  "strategyIde.ctaWorkspaceDescription": "Single-symbol timing · technical factors",
  "strategyIde.portfolioWorkspaceTitle": "Portfolio workspace",
  "strategyIde.portfolioWorkspaceDescription": "Universe selection · ranking · rebalancing",
  "strategyIde.newCtaStrategy": "New CTA strategy",
  "strategyIde.newPortfolioStrategy": "New portfolio strategy",
  "trading-assistant.editor.ctaTemplateIntroTitle": "Choose a CTA starting point",
  "trading-assistant.editor.ctaTemplateIntroDesc": "Templates for single-symbol timing, entries, exits and risk controls.",
  "trading-assistant.editor.portfolioTemplateIntroTitle": "Choose a portfolio starting point",
  "trading-assistant.editor.portfolioTemplateIntroDesc": "Templates for point-in-time universes, cross-sectional ranking and scheduled rebalancing.",
  "trading-assistant.editor.ctaTemplateSection": "CTA strategy templates",
  "trading-assistant.editor.portfolioTemplateSection": "Portfolio strategy templates",
  "trading-assistant.editor.ctaBlankTemplateDesc": "Start from the Strategy API V2 initialize(context) and handle_data(context, data) contract.",
  "trading-assistant.editor.portfolioBlankTemplateDesc": "Start from the portfolio on_rebalance(ctx, panel) contract.",
  "strategyIde.universeLibrary": "Universe library",
  "strategyIde.universeSelected": "Universe · {name}",
  "strategyIde.switchWorkspaceTitle": "Switch workspace",
  "strategyIde.switchWorkspaceContent": "Unsaved changes in the current strategy will be discarded when switching workspaces.",
  "strategyIde.universeApplied": "Universe {name} is now linked to this strategy.",
  "strategyIde.robotTemplates": "Robot templates",
  "strategyIde.robotTemplatesDesc": "Configure grid, DCA, and martingale behavior here, then generate standard editable strategy code.",
  "strategyIde.robotGenerated": "{name} code is ready in the strategy editor.",
  "universeLibrary.title": "Universe Library",
  "universeLibrary.subtitle": "Strategy universe catalog",
  "universeLibrary.description": "Browse system and personal universes, inspect point-in-time members, and link a universe directly to a portfolio strategy.",
  "universeLibrary.portfolioNotice": "Select a universe, then choose Apply to current strategy. Backtests and portfolio live trading will use that universe after it is applied.",
  "universeLibrary.ctaNotice": "CTA strategies trade one instrument. You can inspect members and copy the optional code example here, but universes can only be applied to portfolio strategies.",
  "universeLibrary.currentSelection": "Used by current strategy",
  "universeLibrary.copyReference": "Copy code",
  "universeLibrary.selected": "Applied",
  "universeLibrary.use": "Apply to current strategy",
  "universeLibrary.codeReference": "Code example (optional)",
  "universeLibrary.codeReferenceHint": "For manual strategy coding only. Copying this code does not change or link the current strategy.",
  "universeLibrary.noMembers": "No members are available for this universe.",
  "universeLibrary.selectHint": "Select a universe to inspect its members. Portfolio strategies can apply it directly.",
  "universeLibrary.copySuccess": "Code copied. The current strategy was not changed.",
  "factor.dema.name": "Double Exponential Moving Average",
  "factor.dema.description": "A lower-lag moving average formed from the EMA and the EMA of that EMA.",
  "factor.tema.name": "Triple Exponential Moving Average",
  "factor.tema.description": "A triple-smoothed moving average designed to reduce trend-following lag.",
  "factor.zlema.name": "Zero-Lag Exponential Moving Average",
  "factor.zlema.description": "An EMA applied to lag-adjusted prices to respond faster to changes.",
  "factor.hma.name": "Hull Moving Average",
  "factor.hma.description": "A weighted moving average construction that combines smoothness with reduced lag.",
  "factor.kama.name": "Kaufman Adaptive Moving Average",
  "factor.kama.description": "An adaptive average whose smoothing changes with price efficiency and market noise.",
  "factor.ppo.name": "Percentage Price Oscillator",
  "factor.ppo.description": "The percentage difference between fast and slow EMAs, comparable across instruments.",
  "factor.cmo.name": "Chande Momentum Oscillator",
  "factor.cmo.description": "A bounded oscillator comparing summed gains with summed losses.",
  "factor.awesome_oscillator.name": "Awesome Oscillator",
  "factor.awesome_oscillator.description": "Fast-minus-slow moving averages of the bar median price.",
  "factor.ultimate_oscillator.name": "Ultimate Oscillator",
  "factor.ultimate_oscillator.description": "A momentum oscillator combining buying pressure over three horizons.",
  "factor.tsi.name": "True Strength Index",
  "factor.tsi.description": "Double-smoothed price momentum normalized by double-smoothed absolute momentum.",
  "factor.vortex.name": "Vortex Indicator",
  "factor.vortex.description": "Positive and negative trend movement normalized by true range.",
  "factor.choppiness.name": "Choppiness Index",
  "factor.choppiness.description": "Measures whether recent price action is directional or range-bound.",
  "factor.efficiency_ratio.name": "Efficiency Ratio",
  "factor.efficiency_ratio.description": "Net price change divided by total path movement over the same window.",
  "factor.elder_ray.name": "Elder Ray",
  "factor.elder_ray.description": "Bull or bear power measured relative to an exponential moving average.",
  "factor.force_index.name": "Force Index",
  "factor.force_index.description": "EMA-smoothed price change multiplied by traded volume.",
  "factor.ulcer_index.name": "Ulcer Index",
  "factor.ulcer_index.description": "Root-mean-square percentage drawdown, emphasizing persistent downside risk.",
  "factor.parkinson_volatility.name": "Parkinson Volatility",
  "factor.parkinson_volatility.description": "Range-based annualized volatility estimated from intrabar highs and lows.",
  "factor.garman_klass_volatility.name": "Garman-Klass Volatility",
  "factor.garman_klass_volatility.description": "OHLC-based annualized volatility using both the intrabar range and open-close move.",
  "factor.amihud_illiquidity.name": "Amihud Illiquidity",
  "factor.amihud_illiquidity.description": "Average absolute return per unit of traded value; lower values indicate better liquidity.",
  ...components,
  ...locale,
  "strategyIde.selectScriptLabel": "Current script",
  "strategyIde.selectScriptPlaceholder": "Select saved script source",
  "strategyIde.refreshScripts": "Refresh scripts",
  "strategyIde.saveScript": "Save",
  "strategyIde.saveAsNew": "Save as new",
  "strategyIde.publishScript": "Publish script",
  "strategyIde.deleteScript": "Delete script",
  "strategyIde.backtestTitle": "Backtest",
  "strategyIde.cancel": "Cancel",
  "strategyIde.defaultName": "My Custom Strategy",
  "strategyIde.autoNameSuffix": "Strategy draft",
  "strategyIde.codeRequired": "Please enter script code",
  "strategyIde.hiddenScriptTitle": "Hidden-source script",
  "strategyIde.hiddenScriptDesc": "This script hides its source code. You cannot view or save the code directly, but you can still backtest and create live strategies.",
  "strategyIde.loadScriptsFailed": "Failed to load scripts",
  "strategyIde.loadScriptFailed": "Failed to load script",
  "strategyIde.deleteSuccess": "Script deleted",
  "strategyIde.deleteFailed": "Failed to delete script",
  "strategyIde.newScript": "New script",
  "strategyIde.refresh": "Refresh",
  "strategyIde.restore": "Restore",
  "strategyIde.copy": "Copy",
  "strategyIde.versions": "Versions",
  "strategyIde.delete": "Delete",
  "strategyIde.save": "Save",
  "strategyIde.aiConvert": "AI indicator to strategy",
  "strategyIde.backtest": "Backtest",
  "strategyIde.createLive": "Create live strategy",
  "strategyIde.codeTitle": "Script code",
  "strategyIde.emptyScript": "Empty script",
  "strategyIde.verify": "Validate code",
  "strategyIde.paramTitle": "Code parameters",
  "strategyIde.paramDesc": "Automatically reads context.params(...) and @strategy risk annotations from the current script. Adjust values here and write them back to code.",
  "strategyIde.templatePrompt": "Select a script template in Templates first",
  "strategyIde.templateButton": "Templates",
  "strategyIde.resetParams": "Reset defaults",
  "strategyIde.applyParams": "Apply to code",
  "strategyIde.noParams": "No configurable parameters detected",
  "strategyIde.templateModalTitle": "Templates",
  "strategyIde.templateIntroTitle": "Script starter",
  "strategyIde.templateIntroDesc": "Start from a blank script or database template. Source code owns instrument, market type, frequency, direction, sizing and risk. The run panel supplies capital, dates and permitted Crypto swap leverage.",
  "strategyIde.blankScript": "Blank script",
  "strategyIde.blankScriptDesc": "Only initialize / handle_data skeleton, write logic freely",
  "strategyIde.dbTemplateTitle": "Script templates",
  "strategyIde.dbTemplateEmpty": "No script templates available. Please check database template configuration.",
  "strategyIde.useTemplate": "Use template",
  "strategyIde.loading": "Loading...",
  "strategyIde.loadFailed": "Load failed",
  "strategyIde.saveSuccess": "Script source saved",
  "strategyIde.saveFailed": "Save failed",
  "strategyIde.createSuccess": "Script created",
  "strategyIde.deleteConfirmTitle": "Delete script source?",
  "strategyIde.deleteConfirmDesc": "This will delete the selected script source and cannot be undone.",
  "strategyIde.runningEditBlocked": "A live strategy is using this script. Stop it before editing.",
  "strategyIde.verifyPassed": "Code validation passed",
  ...
  "strategyIde.publishBacktestRequired": "Please run code validation before publishing.",
  "strategyIde.publishModalTitle": "Publish script source to market",
  "strategyIde.publishConfirm": "Confirm publish",
  "strategyIde.marketTag": "Market",
  "strategyIde.publishHint": "Users purchase script source code in the market, then create their own strategy instances from it.",
  "strategyIde.publishName": "Market display name",
  "strategyIde.publishNamePlaceholder": "Enter display name",
  "strategyIde.publishPricingType": "Pricing type",
  "strategyIde.publishFree": "Free",
  "strategyIde.publishPaid": "Paid",
  "strategyIde.publishPrice": "Price",
  "strategyIde.publishDescription": "Strategy description",
  "strategyIde.publishDescriptionPlaceholder": "Supported markets, core logic, risk boundary and suggested usage",
  "strategyIde.priceRequired": "Please enter a valid price",
  "strategyIde.publishVipFree": "VIP free",
  "strategyIde.publishVipFreeHint": "When enabled, VIP users can use this script for free.",
  "strategyIde.publishHideCode": "Hide source code",
  "strategyIde.publishHideCodeHint": "Buyers cannot view source code in the editor. The system can still run charts, backtests and live strategies.",
  "strategyIde.versionHistory": "Version history",
  "strategyIde.versionEmpty": "No versions yet",
  "strategyIde.versionNo": "Version",
  "strategyIde.versionPreview": "Preview",
  "strategyIde.versionRestore": "Restore",
  "strategyIde.versionRestoreTitle": "Restore this version?",
  "strategyIde.versionRestoreContent": "The current editor content will be replaced.",
  "strategyIde.versionPreviewTitle": "Version preview",
  "strategyIde.versionRestored": "Version restored",
  "strategyIde.versionHiddenBlocked": "Hidden-source scripts cannot be previewed or restored.",
  "strategyIde.versionLoadFailed": "Failed to load versions",
  "strategyIde.versionRestoreFailed": "Failed to restore version",
  "strategyIde.indicatorConvertEntry": "AI indicator to strategy",
  "strategyIde.indicatorConvertTitle": "AI indicator to strategy",
  "strategyIde.indicatorConvertConfirm": "Start conversion",
  "strategyIde.indicatorConvertSelect": "Source indicator",
  "strategyIde.indicatorConvertSelectPlaceholder": "Select an indicator",
  "strategyIde.indicatorConvertSelectFirst": "Select an indicator first",
  "strategyIde.indicatorConvertSource": "Source indicator",
  "strategyIde.indicatorConvertInstruction": "Conversion requirements",
  "strategyIde.indicatorConvertPlaceholder": "Example: long only on Cross Up, close on Cross Down, add 2% stop loss and trailing take profit; execute on the next candle after confirmation.",
  "strategyIde.indicatorConvertBoundary": "The conversion creates Strategy API V2 code and preserves the indicator's instrument and timeframe. Source code owns market type, direction, sizing and risk; the run panel supplies capital, dates and permitted Crypto swap leverage.",
  "strategyIde.indicatorConvertNoCodeShort": "No indicator code",
  "strategyIde.indicatorConvertNoCode": "The selected indicator has no source code.",
  ...
  "strategyIde.verifyHints.requiredFunction": "Missing required function: {names}.",
  "strategyIde.verifyHints.legacySignal": "Legacy signal-style APIs are no longer supported. Use ctx Strategy API V2 order APIs.",
  "strategyIde.verifyHints.forbiddenApi": "Unsupported API detected: {names}.",
  "strategyIde.verifyHints.noBarAccess": "handle_data should read bar data or ctx.bars(...) before trading.",
  "strategyIde.verifyHints.noOrder": "No order operation detected. Add open/close/add logic before backtesting or live execution.",
  "strategyIde.verifyHints.syntaxError": "Python syntax error detected.",
  "strategyIde.verifyHints.default": "Code validation issue: {names}.",
  "strategyIde.verifyHints.CTX_PARAM_MISSING_DEFAULT": "context.params(...) is missing a default value on line {count}. Declare parameters in initialize.",
  "strategyIde.verifyHints.CTX_PARAM_RUN_PANEL_FIELD": "The run-panel field should not be declared as context.params: {names}.",
  "strategyIde.verifyHints.INDICATOR_OUTPUT_CONTRACT": "Indicator output contracts are no longer supported for strategy execution. Use ctx Strategy API V2 APIs.",
  "strategyIde.verifyHints.MISSING_ON_INIT": "Missing initialize(ctx).",
  "strategyIde.verifyHints.MISSING_ON_BAR": "Missing handle_data(ctx, bar).",
  "strategyIde.verifyHints.BASKET_CHILD_ORDER_MISSING_LAYER_ORDER": "ctx.basket(...).open_child_order(...) must include layer= and order=.",
  "strategyIde.verifyHints.BASKET_SIDE_MUST_BE_LONG_OR_SHORT": "ctx.basket(side) only accepts long or short, not buy or sell.",
  "strategyIde.verifyHints.EMPTY_CODE": "Code is empty.",
  "backtest-center.portfolioStrategy": "Portfolio Strategy",
  "backtest-center.portfolioConfig": "Portfolio Configuration",
  "backtest-center.universe": "Universe",
  "backtest-center.universePlaceholder": "Select a universe",
  "backtest-center.rebalanceFrequency": "Rebalance Frequency",
  "backtest-center.daily": "Daily",
  "backtest-center.weekly": "Weekly",
  "backtest-center.monthly": "Monthly",
  "backtest-center.maxWeight": "Maximum Weight (%)",
  "backtest-center.minTradeValue": "Minimum Trade Value",
  "backtest-center.allowFractional": "Allow Fractional Shares",
  "backtest-center.portfolioLongOnlyHint": "Version 1 supports long-only Top-N portfolios with next-session execution.",
  "backtest-center.message.universeLoadFailed": "Failed to load universes.",
  "universe.catalog.watchlist": "Watchlist",
  "universe.catalog.csi300": "CSI 300",
  "universe.catalog.csi500": "CSI 500",
  "universe.catalog.sp500": "S&P 500",
  "universe.catalog.nasdaq100": "Nasdaq 100",
  "universe.catalog.etfPool": "ETF Pool",
  "universe.catalog.cryptoTop100": "Top 100 Crypto Assets",
  "universe.catalog.hkEquities": "Hong Kong Equities",
  "strategyIde.ctaStrategy": "CTA Strategy",
  "strategyIde.portfolioStrategy": "Portfolio Strategy",
  "strategyIde.factorLibrary": "Factor library",
  "backtest-center.rebalances": "Rebalances", "backtest-center.orders": "Orders", "backtest-center.buy": "Buy", "backtest-center.sell": "Sell", "backtest-center.signalDate": "Signal date", "backtest-center.executionDate": "Execution date", "backtest-center.grossExposure": "Gross exposure", "backtest-center.cashWeight": "Cash weight", "backtest-center.targetWeights": "Target weights", "backtest-center.quantity": "Quantity", "backtest-center.price": "Price", "backtest-center.notional": "Notional", "backtest-center.fees": "Fees and slippage", "backtest-center.status": "Status", "backtest-center.annualReturn": "Annualized return", "backtest-center.volatility": "Volatility", "backtest-center.turnover": "Turnover", "backtest-center.averagePositions": "Average positions",
  "menu.dashboard.universeManager": "Universes", "universeManager.kicker": "Research universes", "universeManager.title": "Universes", "universeManager.subtitle": "Use maintained system universes, manage personal universes, and inspect every constituent.", "universeManager.reload": "Reload", "universeManager.create": "Create universe", "universeManager.edit": "Edit", "universeManager.name": "Name", "universeManager.market": "Market", "universeManager.members": "Constituents", "universeManager.memberHint": "One symbol per line. Mixed universes use Market:Symbol.", "universeManager.placeholder": "AAPL\nMSFT\nNVDA", "universeManager.mixedPlaceholder": "USStock:AAPL\nHKStock:00700", "universeManager.cancel": "Cancel", "universeManager.save": "Save", "universeManager.catalog": "Universe catalog", "universeManager.symbols": "symbols", "universeManager.status.active": "Ready", "universeManager.status.data_required": "Data required", "universeManager.market.USStock": "US stocks", "universeManager.market.CNStock": "China A-shares", "universeManager.market.HKStock": "Hong Kong stocks", "universeManager.market.Crypto": "Crypto", "universeManager.market.Mixed": "Mixed", "universeManager.saved": "Universe saved.", "universeManager.loadFailed": "Failed to load universes.", "universeManager.saveFailed": "Failed to save universe.", "universeManager.loadMembersFailed": "Failed to load constituents.", "universeManager.mixedFormatError": "Mixed members must use Market:Symbol format.",
  "strategyCenter.editor.timeframeFromStrategy": "The runtime timeframe comes from the strategy source",
  "strategyCenter.editor.defaultMarketDataSource": "Notification mode uses the system default market data source: {exchange}",
  "strategyCenter.editor.ctaStrategy": "CTA strategy",
  "strategyCenter.editor.portfolioStrategy": "Cross-sectional strategy",
  "indicatorIde.signalAlert.title": "Signal notifications",
  "indicatorIde.signalAlert.editCondition": "Edit condition",
  "indicatorIde.signalAlert.setupCondition": "Set notification condition",
  "indicatorIde.signalAlert.currentIndicator": "Current indicator",
  "indicatorIde.signalAlert.sourceHidden": "Source hidden",
  "indicatorIde.signalAlert.sourceVisible": "Source visible",
  "indicatorIde.signalAlert.selectSymbol": "Select symbol",
  "indicatorIde.signalAlert.timeframe": "Timeframe",
  "indicatorIde.signalAlert.triggerSignals": "Trigger signals",
  "indicatorIde.signalAlert.triggerHint": "Signal names are read from output.signals in the indicator code. Choose All signals to monitor any named signal.",
  "indicatorIde.signalAlert.allSignals": "All signals",
  "indicatorIde.signalAlert.channels": "Notification channels",
  "indicatorIde.signalAlert.channelsHint": "In-app notifications appear under the top bell. External channels use the targets below.",
  "indicatorIde.signalAlert.browser": "In-app",
  "indicatorIde.signalAlert.email": "Email",
  "indicatorIde.signalAlert.telegram": "Telegram",
  "indicatorIde.signalAlert.webhook": "Webhook",
  "indicatorIde.signalAlert.emailPlaceholder": "Recipient email",
  "indicatorIde.signalAlert.telegramChatIdPlaceholder": "Telegram Chat ID",
  "indicatorIde.signalAlert.telegramBotTokenPlaceholder": "Bot Token (optional; leave blank to use the system configuration)",
  "indicatorIde.signalAlert.webhookUrlPlaceholder": "Webhook URL",
  "indicatorIde.signalAlert.reset": "Reset",
  "indicatorIde.signalAlert.saveChanges": "Save changes",
  "indicatorIde.signalAlert.createTask": "Create task",
  "indicatorIde.signalAlert.activeTasks": "Active tasks",
  "indicatorIde.signalAlert.emptyTasks": "No signal notification tasks",
  "indicatorIde.signalAlert.running": "Running",
  "indicatorIde.signalAlert.paused": "Paused",
  "indicatorIde.signalAlert.triggerCount": "Triggered {count} times",
  "indicatorIde.signalAlert.error": "Error: {error}",
  "indicatorIde.signalAlert.edit": "Edit",
  "indicatorIde.signalAlert.pause": "Pause",
  "indicatorIde.signalAlert.resume": "Resume",
  "indicatorIde.signalAlert.test": "Test",
  "indicatorIde.signalAlert.delete": "Delete",
  "indicatorIde.signalAlert.selectIndicatorWarning": "Select an indicator first",
  "indicatorIde.signalAlert.loadFailed": "Failed to load signal notification tasks",
  "indicatorIde.signalAlert.selectSymbolWarning": "Select a symbol",
  "indicatorIde.signalAlert.fillEmail": "Enter a recipient email",
  "indicatorIde.signalAlert.fillTelegram": "Enter a Telegram Chat ID",
  "indicatorIde.signalAlert.fillWebhook": "Enter a Webhook URL",
  "indicatorIde.signalAlert.updated": "Signal notification updated",
  "indicatorIde.signalAlert.created": "Signal notification created",
  "indicatorIde.signalAlert.saveFailed": "Failed to save signal notification",
  "indicatorIde.signalAlert.pausedMessage": "Paused",
  "indicatorIde.signalAlert.resumedMessage": "Resumed",
  "indicatorIde.signalAlert.actionFailed": "Action failed",
  "indicatorIde.signalAlert.testTriggered": "Test completed and found a signal",
  "indicatorIde.signalAlert.testNoSignal": "Test completed; the latest closed candle has no selected signal",
  "indicatorIde.signalAlert.testFailed": "Test failed",
  "indicatorIde.signalAlert.deleteConfirmTitle": "Delete signal notification task?",
  "indicatorIde.signalAlert.deleteConfirmContent": "The notification task for {symbol} {timeframe} will stop.",
  "indicatorIde.signalAlert.deleted": "Deleted",
  "indicatorIde.signalAlert.deleteFailed": "Delete failed",
  "trading-assistant.form.initialMargin": "Margin Amount",
